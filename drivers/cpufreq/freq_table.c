...
#define CONFIG_RTK_SUPPORT_BOOST_MODE 1	//kdriver also need to enable cpufreq_enable_boost_support(RTK2851A)
#endif
...
//      policy->max = policy->cpuinfo.max_freq = max_freq;
	...
	policy->min = 800000;
#endif
#endif //CONFIG_RTK_SUPPORT_BOOST_MODE
