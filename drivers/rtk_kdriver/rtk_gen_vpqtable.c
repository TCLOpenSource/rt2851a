...
void VPQ_GenFile_setfile_data(struct file *table_file, VPQC_FILE_struct *file_info, unsigned int id, unsigned int* array , unsigned int size)
{
	file_info->id = id;
	file_info->size = size;
...
//						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_gVipSkipir_Islet, &gVipSkipir_Islet, sizeof(gVipSkipir_Islet));
						...
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_sRGB_Hue_Mapping, (void*)&sRGB_Hue_Mapping, sizeof(sRGB_Hue_Mapping));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_sRGB_RGB_LUT, (void*)&sRGB_RGB_LUT, sizeof(sRGB_RGB_LUT));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_sRGB_YUV2RGB, (void*)&sRGB_YUV2RGB, sizeof(sRGB_YUV2RGB));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_sRGB_RGB2YUV, (void*)&sRGB_RGB2YUV, sizeof(sRGB_RGB2YUV));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_sRGB_APPLY, (void*)&sRGB_APPLY, sizeof(sRGB_APPLY));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_YUV2RGB_Matrix_COEF_601_YCbCr, (void*)&YUV2RGB_Matrix_COEF_601_YCbCr, sizeof(YUV2RGB_Matrix_COEF_601_YCbCr));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tYUV2RGB_COEF_TVBOX_SD, (void*)&tYUV2RGB_COEF_TVBOX_SD, sizeof(tYUV2RGB_COEF_TVBOX_SD));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tYUV2RGB_COEF_TVBOX_HD, (void*)&tYUV2RGB_COEF_TVBOX_HD, sizeof(tYUV2RGB_COEF_TVBOX_HD));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tYUV2RGB_COEF_601_YCbCr_NOClampY, (void*)&tYUV2RGB_COEF_601_YCbCr_NOClampY, sizeof(tYUV2RGB_COEF_601_YCbCr_NOClampY));
						...
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_709_YUV_0_255, (void*)&tRGB2YUV_COEF_709_YUV_0_255, sizeof(tRGB2YUV_COEF_709_YUV_0_255));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_709_YUV_16_235, (void*)&tRGB2YUV_COEF_709_YUV_16_235, sizeof(tRGB2YUV_COEF_709_YUV_16_235));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_709_RGB_0_255, (void*)&tRGB2YUV_COEF_709_RGB_0_255, sizeof(tRGB2YUV_COEF_709_RGB_0_255));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_709_RGB_16_235,(void*) &tRGB2YUV_COEF_709_RGB_16_235, sizeof(tRGB2YUV_COEF_709_RGB_16_235));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_601_RGB_0_255, (void*)&tRGB2YUV_COEF_601_RGB_0_255, sizeof(tRGB2YUV_COEF_601_RGB_0_255));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_601_RGB_16_235, (void*)&tRGB2YUV_COEF_601_RGB_16_235, sizeof(tRGB2YUV_COEF_601_RGB_16_235));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_601_YCbCr_0_255, (void*)&tRGB2YUV_COEF_601_YCbCr_0_255, sizeof(tRGB2YUV_COEF_601_YCbCr_0_255));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_601_YCbCr_16_235,(void*) &tRGB2YUV_COEF_601_YCbCr_16_235, sizeof(tRGB2YUV_COEF_601_YCbCr_16_235));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_601_YCbCr_16_255, (void*)&tRGB2YUV_COEF_601_YCbCr_16_255, sizeof(tRGB2YUV_COEF_601_YCbCr_16_255));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_TVBOX_SD, (void*)&tRGB2YUV_COEF_TVBOX_SD, sizeof(tRGB2YUV_COEF_TVBOX_SD));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_TVBOX_720, (void*)&tRGB2YUV_COEF_TVBOX_720, sizeof(tRGB2YUV_COEF_TVBOX_720));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[file_info_count], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_TVBOX_1080, (void*)&tRGB2YUV_COEF_TVBOX_1080, sizeof(tRGB2YUV_COEF_TVBOX_1080));
