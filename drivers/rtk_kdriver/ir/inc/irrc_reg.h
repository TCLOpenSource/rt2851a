...
#define PINMUX_ST_ST_CFG_1_REG                  (PINMUX_MAIN_ST_GPIO_ST_CFG_2_reg)
#define PINMUX_ST_ST_CFG_1_IRRX_MASK            (PINMUX_MAIN_ST_GPIO_ST_CFG_2_st_gpio_10_ps_mask)
#define PINMUX_ST_ST_CFG_1_IRRX_DATA            (PINMUX_MAIN_ST_GPIO_ST_CFG_2_st_gpio_10_ps_mask&((0x8)<<PINMUX_MAIN_ST_GPIO_ST_CFG_2_st_gpio_10_ps_shift))
