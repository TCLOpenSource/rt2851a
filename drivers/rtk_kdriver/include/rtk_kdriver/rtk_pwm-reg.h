...
#define PWM_VRR_DTG_IE               PPOVERLAY_DTG_ie_reg
#define PWM_VRR_DTG_PENDING_STATUS   PPOVERLAY_DTG_pending_status_reg
...
#define  MIS_PWM0_HW_PREDICT_VADDR                 (PWM_RESERVED_VADDR)
#define  MIS_PWM0_SW_PREDICT_VADDR                 (PWM_RESERVED_VADDR)
#define  MIS_PWM0_PREDICT_RATIO_VADDR              (PWM_RESERVED_VADDR)
...
#define  MIS_PWM1_HW_PREDICT_VADDR                 (PWM_RESERVED_VADDR)
#define  MIS_PWM1_SW_PREDICT_VADDR                 (PWM_RESERVED_VADDR)
#define  MIS_PWM1_PREDICT_RATIO_VADDR              (PWM_RESERVED_VADDR)
...
#define pwm_db0_ctrl_RBUS                          misc_pwm_pwm_db0_ctrl_RBUS
#define iso_pwm_db_ctrl_RBUS                       iso_misc_pwm_mis_pwm_db_ctrl_RBUS
#define pwm_mis_db1_ctrl_RBUS                      misc_pwm_pwm_db1_ctrl_RBUS

//MISC Basic Function Register
#define pwm_ctrl_RBUS                              misc_pwm_pwm0_ctrl_RBUS
...
void PWM_VRR_DTG_IE_REG_R(ppoverlay_dtg_ie_RBUS *pwm_vrr_dtg_ie_reg);
void PWM_VRR_DTG_IE_REG_W(ppoverlay_dtg_ie_RBUS *pwm_vrr_dtg_ie_reg);
...
void I_PWM_DB_CTRL_REG_R(int index,iso_pwm_db_ctrl_RBUS* pwm_iso_db_ctrl_reg);
void I_PWM_DB_CTRL_REG_W(int index,iso_pwm_db_ctrl_RBUS* pwm_iso_db_ctrl_reg);
