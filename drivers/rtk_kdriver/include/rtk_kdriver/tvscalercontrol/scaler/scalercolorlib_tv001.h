...
typedef struct _RTK_Final_Gamma {
	unsigned short final_gamma_r[1024];
	unsigned short final_gamma_g[1024];
	unsigned short final_gamma_b[1024];
...
typedef enum _D_3DLUT_ITEM{
 ...
 typedef struct{
	 ...
	 unsigned int D_3DLUT_Data[VIP_D_3DLUT_999_NUM][VIP_D_3D_LUT_SIZE][VIP_8VERTEX_RGB_MAX];
}RTK_VPQ_3DLUT_PARAM;
