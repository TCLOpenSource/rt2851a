...
typedef enum
{
	TP_DELIVERY_MODE_ATSC30 = 0,
	TP_DELIVERY_MODE_ATSC30_ALP,
	TP_DELIVERY_MODE_JAPAN4K,
    TP_DELIVERY_MODE_UNKNOWN    = 3,  //default: DVB/ATSC1.0..
    TP_DELIVERY_MODE_TS         = TP_DELIVERY_MODE_UNKNOWN,  //default: DVB/ATSC1.0..
