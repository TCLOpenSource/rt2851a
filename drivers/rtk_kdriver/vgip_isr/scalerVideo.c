...
void scalerVideo_UpdateFrequencyOffset()
{
	...
	vdpq_dummy_4_RBUS vdpq_dummy_4_reg;
#endif
	...
	if(DelayCounter <= 7 )
	{
		...
		ScalerVideo_Status.FrequencyOffset = 0; //disable FrequencyOffset on Mac series
#if 0
		vdpq_dummy_4_reg.regValue = VDPQ_rtd_inl(VDPQ_Dummy_4_reg);
		vdpq_dummy_4_reg.regValue = scalerVideo_BitWiseOperation(vdpq_dummy_4_reg.regValue, 0, 31, ScalerVideo_Status.FrequencyOffset, VD_BIT_SET);
		VDPQ_rtd_outl(VDPQ_Dummy_4_reg, vdpq_dummy_4_reg.regValue);
#endif
	}
	DelayCounter++;
	if( DelayCounter == 30 )
	...
	// Update status to dummy register >> calculate the frequency offset
	/*
	-5: -24
	-4: -19, -20
	-3: -14, -15
	...
	*/
#if 0
	vdpq_dummy_5_reg.regValue = VDPQ_rtd_inl(VDPQ_Dummy_5_reg);
	if(frmCnt == 0)
	{
		vdpq_dummy_5_reg.regValue = scalerVideo_BitWiseOperation(vdpq_dummy_5_reg.regValue, 31, 31, ((ptsOft<0)? 1 : 0), VD_BIT_SET);
		vdpq_dummy_5_reg.regValue = scalerVideo_BitWiseOperation(vdpq_dummy_5_reg.regValue, 24, 30, ABS(ptsOft, 0), VD_BIT_SET);
		ptsOft = 0;
	}
	vdpq_dummy_5_reg.regValue = scalerVideo_BitWiseOperation(vdpq_dummy_5_reg.regValue, 0, 23, curCnt, VD_BIT_SET);
	VDPQ_rtd_outl(VDPQ_Dummy_5_reg, vdpq_dummy_5_reg.regValue);
#endif
	preCnt = curCnt;
}
