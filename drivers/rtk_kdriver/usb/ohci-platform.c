...
static inline struct ohci_hcd *ohci_priv_to_ohci(struct ohci_platform_priv *priv)
{
	return container_of((void *)priv, struct ohci_hcd, priv);
}
...
static int ohci_platform_probe(struct platform_device *dev)
{
...
#ifdef CONFIG_ARM64
    hcd->regs = (void __iomem *)0xb8013400;
#else
	...
	phy_mac_completion = id_get_companion_ehci_completion(pdata->id);
	...
	list_add_tail(&priv->ohci_list, &ohci_list_head); /* This is used to track how many ohci we have */
