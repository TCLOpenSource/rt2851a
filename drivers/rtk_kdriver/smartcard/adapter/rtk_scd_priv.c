...
static void scd_load_gpio_config(scd *p_this)
{
	...
	// PinMux for Mac7p Board
	rtd_outl(0xB8000880, (rtd_inl(0xB8000880) & ~(0xF << 28)) | (0x4 << 28));/* CD 0xB8000880[31:28] 4: SC_CD_src0 H20*/
	rtd_outl(0xB80008c4, (rtd_inl(0xB80008c4) & ~(0x0 << 12))); /* CD src in input mux, select src0, 4:0xB80008c4[13:12] = 0x0*/

	rtd_outl(0xB8000878, (rtd_inl(0xB8000878) & ~(0xF << 4)) | (0x4 << 4)); /* IO 0xB8000878[7:4]; 4: SC_DATA_src0 J19*/
	rtd_outl(0xB80008c4, (rtd_inl(0xB80008c4) & ~(0x0 << 12))); /* IO data in input mux, select src0, 4:0xB80008c4[13:12] = 0x0 */

	rtd_outl(0xB800087c, (rtd_inl(0xB800087c) & ~(0xF << 28)) | (0x4 << 28)); /* RST 0xB800087c[31:28] 4: SC_RST J18*/
	rtd_outl(0xB800087c, (rtd_inl(0xB800087c) & ~(0xF << 12)) | (0x4 << 12)); /* CLK 0xB800087c[15:12] 4: SC_SCLK H21*/

	rtd_outl(0xB8000818, rtd_inl(0xB8000818) | (0xF << 28));    /*PWR SEL  : MISC GPIO 00 R7, 0xB8000818[31:28]*/
	rtd_outl(0xB8000888, rtd_inl(0xB8000888) | (0xF << 20));    /* CMD VCC : MISC GPIO 72 F19, 0xB8000888[23:20]*/
