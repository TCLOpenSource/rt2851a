                           ...
                           unsigned int cmd, unsigned long arg)
{
    ...
    memset(&gpio_val, 0 ,  sizeof(RTK_GPIO_VAL_T));
    memset(&gpio_dir, 0, sizeof(RTK_GPIO_DIR_T));
    memset(&gpio_irq_flag, 0, sizeof(RTK_GPIO_IRQ_FLAG_T));
    memset(&gpio_irq_set, 0, sizeof(RTK_GPIO_IRQ_SET_T));
    memset(&gpio_irq_en, 0, sizeof(RTK_GPIO_IRQ_EN_T));
    memset(&gpio_all_gpio_pin, 0, sizeof(RTK_GPIO_GET_ALL_GPIO_PIN_T));
    switch (cmd) {
	    ...
	    gpio_val.pin_name[sizeof(gpio_val.pin_name) - 1] = '\0';
	    ...
	    gpio_dir.pin_name[sizeof(gpio_dir.pin_name) - 1] = '\0';
	    ...
	    gpio_irq_set.pin_name[sizeof(gpio_irq_set.pin_name) - 1] = '\0';
	    ...
	    gpio_irq_en.pin_name[sizeof(gpio_irq_en.pin_name) - 1] = '\0';
	    ...
	    gpio_irq_flag.pin_name[sizeof(gpio_irq_flag.pin_name) - 1] = '\0';
