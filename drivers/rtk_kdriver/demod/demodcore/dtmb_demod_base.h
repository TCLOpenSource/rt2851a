...
#define REALTEK_H_DTMB_BASE_DBG(fmt, args...)         rtd_printk_demod(KERN_DEBUG, "DEMO","Dtmb Debug, " fmt, ##args);
#define REALTEK_H_DTMB_BASE_INFO(fmt, args...)        rtd_printk_demod(KERN_INFO, "DEMO","Dtmb Info, " fmt, ##args);
#define REALTEK_H_DTMB_BASE_WARNING(fmt, args...)     rtd_printk_demod(KERN_WARNING, "DEMO","Dtmb Warning, " fmt, ##args);
#ifdef __cplusplus
}
#endif
#endif
