...
int emcu_customer_setting(u32 ctl)
{
	...
	if((share_led_tmp == 0x0) || (share_led_tmp == 0xf2a0d5))
	{
	...
	if((share_tmp == 0x0) || (share_ir_tmp == 0x0)) {
		...
		if(ir_protocol == 1){ //TCL use NEC for Korea Remote
        rtd_outl(RTD_SHARE_MEM_BASE             ,0x2c0001);
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x1), 0x10090a);
        ...
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0xd), 0x1);
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0xe), 0x2ad59966);//0xf2a0d5);//power
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0xf), 0xef109966);//0xfef010);//netflix
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x10), 0x31ce9966);//0xf300cf);//0
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x11), 0x32ce9966);//0xf310ce);//1
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x12), 0x33ce9966);//0xf320cd);//2
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x13), 0x34ce9966);//0xf330cc);//3
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x14), 0x35ce9966);//0xf340cb);//4
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x15), 0x36ce9966);//0xf350ca);//5
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x16), 0x37ce9966);//0xf360c9);//6
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x17), 0x38ce9966);//0xf370c8);//7
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x18), 0x39ce9966);//0xf380c7);//8
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x19), 0x30cf9966);//0xf390c6);//9
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x1a), 0x0);
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x1b), 0x3);
        //rtd_outl(RTD_SHARE_MEM_BASE+4*(0x1c), 0x4c000001);
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x1d), 0x400b04);
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x1e), 0x400904);
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x1f), 0);
        }
		else if(ir_protocol == 8){
        rtd_outl(RTD_SHARE_MEM_BASE             ,0x2c0001);
        ...
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x1b), 0x3);
        //rtd_outl(RTD_SHARE_MEM_BASE+4*(0x1c), 0x4c000001);
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x1d), 0x400029);
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x1e), 0x5940001e);
        rtd_outl(RTD_SHARE_MEM_BASE+4*(0x1f), 0x56400027);
        }
