...
enum VIDEO_VF_TYPE
{
    ...
    VF_TYPE_VIDEO_COMPOSER,
    VF_TYPE_VIDEO_AV1_DECODER
};
...
enum SP_STREAM_TYPE
{
  ...
  SP_SRT_TYPE,
  SP_SSA_TYPE,
  SP_QWER_XSUB_PLUS_TYPE,
  SP_DVD_FOR_QWER_TYPE,
  SP_BD_SUBTITLE_TYPE
} ;
...
enum RPC_SLR_AFD_TYPE{
 ...
 RPC_SLR_AFD_RESERVE2,
 RPC_SLR_AFD_BOX_16X9,
 RPC_SLR_AFD_BOX_14X9,
 RPC_SLR_AFD_BOX_G16X9,
 RPC_SLR_AFD_RESERVE3,
 RPC_SLR_AFD_RESERVE4,
 RPC_SLR_AFD_RESERVE5,
 RPC_SLR_AFD_SAME_AS_FRAME,
 RPC_SLR_AFD_4X3,
 RPC_SLR_AFD_16X9,
 RPC_SLR_AFD_14X9,
 RPC_SLR_AFD_RESERVE6,
 RPC_SLR_AFD_4X3_SP,
 RPC_SLR_AFD_16X9_SP,
 RPC_SLR_AFD_16X9_SP_4X3
};
