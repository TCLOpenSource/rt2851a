...
struct VIDEO_RPC_SET_SCALE {
	unsigned int Qwer_Certify; /* enable Scaling flow*/
...
{
  unsigned int                  ulCmd;       /* RPC command */
  unsigned int                  ulArgAddr;   /* Share memory physical address */
  unsigned int                  ulArgSize;   /* Share memory size */
} ;


struct SCALER_RPC_SHARE_MEM
{
  unsigned int                  ulAddr[50];       /* struct memory addr in share memory */
} ;
...
struct VIDEO_RPC_VOUT_CONFIG_HDMI_3D
{
  ...
  unsigned int			overscan_v_start;
  unsigned int			overscan_v_len;
  unsigned int			hdr_source;
  unsigned int			hdmi_4k120_flag;
  int					reserved4 ;
} ;
...
unsigned int      pixelAR_hor;
unsigned int      pixelAR_ver;
unsigned int       se_pre_width;
...
unsigned int      xvYCC;
unsigned int      isAdobeRGB;
unsigned int      transfer_characteristics;
unsigned int      matrix_coefficiets;
...
/**
 *  \fn  HRESULT  VIDEO_RPC_VOUT_ToAgent_VOCompFlush (long x)
 *
 *  \brief
 *
 *  \return
 ...
 *  \param
 */
  HRESULT VIDEO_RPC_VOUT_ToAgent_VOCompFlush(long x) = VIDEO_RPC_COMMON_FUNC_BASE + 81 ;
...
/*  ------------------------------------------------------------------------------------
  Signature:
  HRESULT     VIDEO_RPC_ENC_ToAgent_SetEncode_RAWIN_Format(VIDEO_RPC_ENC_SET_RAWIN_FORMAT x) = 270;

  Function:
    Set Encoder Format to 
      ------------------------------------------------------------------------------------ */
  HRESULT     VIDEO_RPC_ENC_ToAgent_SetEncode_RAWIN_Format(VIDEO_RPC_ENC_SET_RAWIN_FORMAT x) = VIDEO_RPC_VENC_FUNC_BASE + 270 ;
 ...
 ************************************************************************
 * \brief
 *    VIDEO_RPC_VOUT_ToAgent_SetDemuxSpeed
 *
 * \return
 *
 * \param
 ************************************************************************
 */
HRESULT VIDEO_RPC_VOUT_ToAgent_SetDemuxSpeed () = VIDEO_RPC_VOUT_FUNC_BASE + 293 ;
 ...
 ************************************************************************
 * \brief
 *    This function is used to set the SubPicture PTS offset
 * \return
 *
 * \param  PTSOffset:
 *    offset in 90k counter unit
 ************************************************************************
 */
HRESULT VIDEO_RPC_VO_FILTER_ToAgent_SetSPPTSOffset (VIDEO_RPC_VO_FILTER_SPPTSOffset x) = VIDEO_RPC_VOUT_FUNC_BASE + 385 ;
 ...
 ************************************************************************
 * \brief
 *    This function is used to info vsc is disconnected.
 *
 * \return
 *
 ************************************************************************
 */
HRESULT VIDEO_RPC_VOUT_ToAgent_VSCDISCONNECT_TO_VODMA (VIDEO_RPC_VOUT_VSCINPUTTYPE x) = VIDEO_RPC_VOUT_FUNC_BASE + 667;


/**
 ************************************************************************
 * \brief
 *    This function is used to connect vdo and vdec port to vodma
 *
 * \return
 *
 ************************************************************************
 */
HRESULT VIDEO_RPC_VOUT_ToAgent_VDOCONNECT_TO_VODMA () = VIDEO_RPC_VOUT_FUNC_BASE + 668;
 ...
 ************************************************************************
 * \brief
 *    This function is used to disconnect vdo and vdec port to vodma
 *
 * \return
 *
 ************************************************************************
 */
HRESULT VIDEO_RPC_VOUT_ToAgent_VDODISCONNECT_TO_VODMA () = VIDEO_RPC_VOUT_FUNC_BASE + 669;
 ...
 ************************************************************************
 * \brief
 *    This function is used to borrow VBM memc memory
 *
 * \return
 *
 * \param  VIDEO_RPC_VBM_BORROWMEMCHUNK
 *
 ************************************************************************
 */
HRESULT VIDEO_RPC_ToAgent_BorrowVBMMemChunk (VIDEO_RPC_VBM_BORROWMEMCHUNK x)  = VIDEO_RPC_VOUT_FUNC_BASE + 803 ;


/*
 ************************************************************************
 * \brief
 *    This function is used to return VBM memc memory
 *
 * \return
 *
 * \param  VIDEO_RPC_VBM_RETURNMEMCHUNK
 *
 ************************************************************************
 */
HRESULT VIDEO_RPC_ToAgent_ReturnVBMMemChunk (VIDEO_RPC_VBM_RETURNMEMCHUNK x)  = VIDEO_RPC_VOUT_FUNC_BASE + 804 ;
 ...
 ************************************************************************
 * \brief
 *    VIDEO_RPC_ToAgent_VP_Sequential2Block
 *
 * \return
 *
 * \param
 ...
 ************************************************************************
 */
HRESULT VIDEO_RPC_ToAgent_VP_Sequential2Block ()  = VIDEO_RPC_VOUT_FUNC_BASE + 824 ;


/*!
 ************************************************************************
 * \brief
 *    VIDEO_RPC_ToAgent_SE_Alpha
 *
 * \return
 *
 * \param
 ...
 ************************************************************************
 */
HRESULT VIDEO_RPC_ToAgent_SE_Alpha ()  = VIDEO_RPC_VOUT_FUNC_BASE + 830 ;
 ...
 ************************************************************************
 * \brief
 *    This function is used to VIDEO_RPC_VOUT_ToAgent_VoDriverReady
 * \return
 *
 ************************************************************************
 */
HRESULT VIDEO_RPC_VOUT_ToAgent_VoDriverReady () = VIDEO_RPC_VOUT_FUNC_BASE + 999 ;
...
/**
 * \fn  HRESULT  VIDEO_RPC_VO_FILTER_ToAgent_GetVoInfo (long)
 * \brief This function is used to return detailed VoInfo to system.
 *
 * \return
 * \param  A VO_PRC_VOINFO struct.
 */
VO_PRC_VOINFO VIDEO_RPC_VO_FILTER_ToAgent_GetVoInfo (long instanceID) =VIDEO_RPC_VOUT_FUNC_BASE + 940 ;
 ...
 ************************************************************************
*/
HRESULT VIDEO_RPC_VO_FILTER_ToAgent_SetAppType (VIDEO_RPC_VO_FILTER_SET_APP_TYPE x) = VIDEO_RPC_VOUT_FUNC_BASE + 950 ;
...
HRESULT VIDEO_RPC_VO_PHOTO_ToAgent_SetAVsyncDelayTime (int time) = VIDEO_RPC_VO_PHOTO_FUNC_BASE + 80 ;
