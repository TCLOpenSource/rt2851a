 ...
 */
   ...
   HRESULT      AUDIO_RPC_ToAgent_Run(rpc_s32_t)=4;
 ...
 */
   ...
   HRESULT      AUDIO_RPC_ToAgent_Pause(rpc_s32_t)=5;
 ...
 */
    ...
    HRESULT     AUDIO_RPC_ToAgent_Stop(rpc_s32_t)=6;
 ...
 */
  ...
  HRESULT       AUDIO_RPC_ToAgent_Destroy(rpc_s32_t)=7;
 ...
 */
    ...
    AUDIO_RPC_GET_PTS_INFO         AUDIO_RPC_DEC_ToAgent_GetPTS(rpc_s32_t instanceID) = 34;
 ...
 */
  ...
  HRESULT       AUDIO_RPC_ToAgent_AOUT_ResetPin(rpc_s32_t)=126;
 ...
 *  \param  a key
 */
HRESULT     AUDIO_RPC_ToAgent_SetAuthorityKey(rpc_s32_t) = 160;
...
/**
 *  \fn HRESULT   AUDIO_RPC_ToAgent_Set_A2DP_Clock(AUDIO_RPC_SET_AC4_DIALENHANCEGAIN)
 *  \brief  To inform f/w A2DP clock report
 *  \return
 */
HRESULT AUDIO_RPC_ToAgent_Set_A2DP_Clock(AUDIO_RPC_SET_A2DP_CLOCK)=166;
...
/** temp **/
  ...
  HRESULT       AUDIO_RPC_ToAgent_PP_InitPin(rpc_s32_t)=214;

 /**
 *  \fn HRESULT     AUDIO_RPC_ToAgent_AskDebugMemoryAddress(rpc_u32_t x)
 ...
 */
  ...
  HRESULT       AUDIO_RPC_ToAgent_AskDebugMemoryAddress(rpc_u32_t x) = 215;
...
/* Audio PP function RPC call */
  ...
  AUDIO_RPC_DEC_FORMAT_INFO AUDIO_RPC_DEC_ToAgent_GetAudioFormatInfo(rpc_s32_t instanceID) = 226;
...
/* Audio AO function RPC call */
  ...
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn016(AUDIO_RPC_LGSE_SETFN016)=278;

  /* Audio AO function Virtual X RPC call */
/**
  HRESULT       AUDIO_RPC_ToAgent_AO_VirtualX_Trusrndx_SetParam(AUDIO_VIRTUALX_TRUSRNDX_PARAM_INFO)=272;
  HRESULT       AUDIO_RPC_ToAgent_AO_VirtualX_Tbhdx_SetParam(AUDIO_VIRTUALX_TBHDX_PARAM_INFO)=273;
  HRESULT       AUDIO_RPC_ToAgent_AO_VirtualX_Mbhl_SetParam(AUDIO_VIRTUALX_MBHL_PARAM_INFO)=274;
  HRESULT       AUDIO_RPC_ToAgent_AO_VirtualX_Trusrndx_SetAllParam(AUDIO_VIRTUALX_TRUSRNDX_ALLPARAM_INFO)=275;
  HRESULT       AUDIO_RPC_ToAgent_AO_VirtualX_Tbhdx_SetAllParam(AUDIO_VIRTUALX_TBHDX_ALLPARAM_INFO)=276;
  HRESULT       AUDIO_RPC_ToAgent_AO_VirtualX_Tbhdx_SetCoeff(AUDIO_VIRTUALX_TBHDX_COEFF_INFO)=277;
**/
...
/* get audio format from AI */
  AUDIO_RPC_AIN_FORMAT_INFO AUDIO_RPC_AIN_ToAgent_GetAudioFormatInfo(rpc_s32_t instanceID) = 271;

/* License Control */
/**
 *  \fn HRESULT     AUDIO_RPC_ToAgent_Capability_SetMask(rpc_s32_t x)
 ...
 *
 */
    HRESULT                 AUDIO_RPC_ToAgent_Capability_SetMask(rpc_s32_t)=250;

/**
 *  \fn HRESULT     AUDIO_RPC_ToAgent_AudioHalt(rpc_s32_t)
 ...
 */
   ...
   HRESULT      AUDIO_RPC_ToAgent_AudioHalt(rpc_s32_t)=251;

/**
 *  \fn HRESULT AUDIO_RPC_ToAgent_Full_Capability_SetMask(rpc_s32_t x)
