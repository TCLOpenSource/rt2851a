...
HRESULT *
VIDEO_RPC_VOUT_ToAgent_VOCompFlush_0(long *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	if (client_call (&rpc, VIDEO_RPC_VOUT_ToAgent_VOCompFlush, clnt->sendMode,
		(xdrproc_t) xdr_long, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
...
HRESULT *
VIDEO_RPC_ENC_ToAgent_SetEncode_RAWIN_Format_0(VIDEO_RPC_ENC_SET_RAWIN_FORMAT *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	RPC_STRUCT rpc;
	HRESULT * result = NULL ;
	long args_size = sizeof(VIDEO_RPC_ENC_SET_RAWIN_FORMAT );
	unsigned char pool;
	...
	if (client_call (&rpc, VIDEO_RPC_ENC_ToAgent_SetEncode_RAWIN_Format, clnt->sendMode,
		(xdrproc_t) xdr_VIDEO_RPC_ENC_SET_RAWIN_FORMAT, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
		return (HRESULT *)-1;
...
HRESULT *
VIDEO_RPC_VOUT_ToAgent_SetDemuxSpeed_0(void *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	if (client_call (&rpc, VIDEO_RPC_VOUT_ToAgent_SetDemuxSpeed, clnt->sendMode,
		(xdrproc_t) xdr_void, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
...
HRESULT *
VIDEO_RPC_VO_FILTER_ToAgent_SetSPPTSOffset_0(VIDEO_RPC_VO_FILTER_SPPTSOffset *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	RPC_STRUCT rpc;
	HRESULT * result = NULL ;
	long args_size = sizeof(VIDEO_RPC_VO_FILTER_SPPTSOffset );
	unsigned char pool;
	...
	if (client_call (&rpc, VIDEO_RPC_VO_FILTER_ToAgent_SetSPPTSOffset, clnt->sendMode,
		(xdrproc_t) xdr_VIDEO_RPC_VO_FILTER_SPPTSOffset, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
		return (HRESULT *)-1;
...
HRESULT *
VIDEO_RPC_VOUT_ToAgent_VSCDISCONNECT_TO_VODMA_0(VIDEO_RPC_VOUT_VSCINPUTTYPE *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	if (client_call (&rpc, VIDEO_RPC_VOUT_ToAgent_VSCDISCONNECT_TO_VODMA, clnt->sendMode,
		(xdrproc_t) xdr_VIDEO_RPC_VOUT_VSCINPUTTYPE, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
...
HRESULT *
VIDEO_RPC_VOUT_ToAgent_VDOCONNECT_TO_VODMA_0(void *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	if (client_call (&rpc, VIDEO_RPC_VOUT_ToAgent_VDOCONNECT_TO_VODMA, clnt->sendMode,
		(xdrproc_t) xdr_void, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
...
HRESULT *
VIDEO_RPC_VOUT_ToAgent_VDODISCONNECT_TO_VODMA_0(void *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	if (client_call (&rpc, VIDEO_RPC_VOUT_ToAgent_VDODISCONNECT_TO_VODMA, clnt->sendMode,
		(xdrproc_t) xdr_void, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
...
HRESULT *
VIDEO_RPC_ToAgent_BorrowVBMMemChunk_0(VIDEO_RPC_VBM_BORROWMEMCHUNK *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	RPC_STRUCT rpc;
	HRESULT * result = NULL ;
	long args_size = sizeof(VIDEO_RPC_VBM_BORROWMEMCHUNK );
	unsigned char pool;
	...
	if (client_call (&rpc, VIDEO_RPC_ToAgent_BorrowVBMMemChunk, clnt->sendMode,
		(xdrproc_t) xdr_VIDEO_RPC_VBM_BORROWMEMCHUNK, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
		return (HRESULT *)-1;
...
HRESULT *
VIDEO_RPC_ToAgent_ReturnVBMMemChunk_0(VIDEO_RPC_VBM_RETURNMEMCHUNK *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	RPC_STRUCT rpc;
	HRESULT * result = NULL ;
	long args_size = sizeof(VIDEO_RPC_VBM_RETURNMEMCHUNK );
	unsigned char pool;
	...
	if (client_call (&rpc, VIDEO_RPC_ToAgent_ReturnVBMMemChunk, clnt->sendMode,
		(xdrproc_t) xdr_VIDEO_RPC_VBM_RETURNMEMCHUNK, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
		return (HRESULT *)-1;
...
HRESULT *
VIDEO_RPC_ToAgent_VP_Sequential2Block_0(void *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	if (client_call (&rpc, VIDEO_RPC_ToAgent_VP_Sequential2Block, clnt->sendMode,
		(xdrproc_t) xdr_void, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
...
HRESULT *
VIDEO_RPC_ToAgent_SE_Alpha_0(void *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	if (client_call (&rpc, VIDEO_RPC_ToAgent_SE_Alpha, clnt->sendMode,
		(xdrproc_t) xdr_void, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
...
HRESULT *
VIDEO_RPC_VOUT_ToAgent_VoDriverReady_0(void *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	if (client_call (&rpc, VIDEO_RPC_VOUT_ToAgent_VoDriverReady, clnt->sendMode,
		(xdrproc_t) xdr_void, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
...
VO_PRC_VOINFO *
VIDEO_RPC_VO_FILTER_ToAgent_GetVoInfo_0(long *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	// if NONBLOCK_MODE, dont need to alloc memory
	if (clnt->sendMode & BLOCK_MODE) {
		result = (VO_PRC_VOINFO *) AllocateMem(sizeof(VO_PRC_VOINFO ), &pool);
	}
	...
	if (client_call (&rpc, VIDEO_RPC_VO_FILTER_ToAgent_GetVoInfo, clnt->sendMode,
		(xdrproc_t) xdr_long, (caddr_t) argp, args_size)
		!= RPC_SUCCESS) {
		if(result)
			ReleaseMem(result);
		return (VO_PRC_VOINFO *)-1;
	}
	...
	if (clnt->sendMode & BLOCK_MODE) {
		...
		waitReply();
		xdrmem_create(&xdrs, (char *)result, sizeof(VO_PRC_VOINFO), XDR_DECODE);
		 if(!xdr_VO_PRC_VOINFO(&xdrs, result))
			 return (VO_PRC_VOINFO *)-1;
		return result;
	}
...
HRESULT *
VIDEO_RPC_VO_PHOTO_ToAgent_SetAVsyncDelayTime_0(int *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
  ...
  #pragma message("BUILD_FOR_KCPU_COMMON is #define'd to 0" )
	...
	if (client_call (&rpc, VIDEO_RPC_VO_PHOTO_ToAgent_SetAVsyncDelayTime, clnt->sendMode,
