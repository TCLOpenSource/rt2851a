...
struct AUDIO_SPECTRUM_CFG {
	...
	rpc_s32_t bandnum;
	rpc_s32_t data_addr;
	rpc_s32_t upper_bandlimit_addr;
};
...
struct AUDIO_PROLOGIC2_MODE {
	...
	rpc_s32_t abaldisable;
	rpc_s32_t chanconfig;
	rpc_s32_t dimset;
	rpc_s32_t surfiltenable;
	rpc_s32_t modeselect;
	rpc_s32_t panoramaenable;
	rpc_s32_t fix_pcmscalefac;
	rpc_s32_t rsinvenable;
	rpc_s32_t samprateid;
	rpc_s32_t cwidthset;
};
...
struct AUDIO_RPC_BASS_MANAGEMENT_MODE {
	rpc_s32_t cutoffFreq;
	rpc_s32_t config_mode;
	rpc_s32_t subwoofer_ena;
};
...
enum AUDIO_ENUM_PRIVAETINFO {
	...
	ENUM_PRIVATEINFO_AUDIO_GET_SNDOUT_LATENCY = 94,
};
...
struct USB_AUDIO_IN_INFO {
	rpc_u32_t command;
	rpc_u32_t usb_ai_ringbuf_addr;
	rpc_u32_t usb_ai_samplerate;
	rpc_u32_t usb_ai_format;
	rpc_u32_t usb_ai_max_chnum;
};
...
enum enum_dtsParamVirtualxlib1Type {
	...
	ENUM_DTS_PARAM_TSX_HEIGHT_DISCARD_I32 = 0x10019400 + 14,
	ENUM_DTS_PARAM_TSX_FRNT_CTRL_I32 = 0x10019400 + 15,
	ENUM_DTS_PARAM_TSX_SRND_CTRL_I32 = 0x10019400 + 16,
	ENUM_DTS_PARAM_VX_DC_ENABLE_I32 = 0x10019400 + 17,
	ENUM_DTS_PARAM_VX_DC_CONTROL_I32 = 0x10019400 + 18,
	ENUM_DTS_PARAM_VX_DEF_ENABLE_I32 = 0x10019400 + 19,
	ENUM_DTS_PARAM_VX_DEF_CONTROL_I32 = 0x10019400 + 20,
	ENUM_DTS_PARAM_TSX_CONTROLS_STU = 0x10019400 + 21,
...
typedef struct AUDIO_RPC_SET_A2DP_CLOCK AUDIO_RPC_SET_A2DP_CLOCK;
