#ifndef _VR_DEVICE_ID_H_
#define _VR_DEVICE_ID_H_
...
typedef enum
{
	KADP_VR_SCALER_INPUT = 0,
	KADP_VR_SCALER_OUTPUT,
	KADP_VR_DISPLAY_OUTPUT,
	KADP_VR_OSDVIDEO_OUTPUT,
	KADP_VR_OSD_OUTPUT,
	KADP_VR_MAX_LOCATION
...
#define VR_IOC_WAIT_VSYNC								_IOW(VR_IOC_MAGIC, VR_IOC_IDX_16, KADP_VR_VIDEO_WINDOW_TYPE_T)
...
#define VR_IOC_EnableFRCMode							_IOR(VR_IOC_MAGIC, VR_IOC_IDX_27, unsigned int)
#define VR_IOC_SET_OUTPUT_FPS                           _IOW(VR_IOC_MAGIC, VR_IOC_IDX_28, unsigned int)
