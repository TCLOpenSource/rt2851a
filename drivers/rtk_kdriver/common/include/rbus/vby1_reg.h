...
#define  VBY1_CRC_CONTROL_lane_crc_en_mask                                       (0x00FF0000)
...
#define  VBY1_CRC_CONTROL_lane_crc_en(data)                                      (0x00FF0000&((data)<<16))
...
#define  VBY1_CRC_CONTROL_get_lane_crc_en(data)                                  ((0x00FF0000&(data))>>16)
...
#define  VBY1_DPHY_RD_e8b10b_running_disparity_mask                              (0x000000FF)
#define  VBY1_DPHY_RD_e8b10b_running_disparity(data)                             (0x000000FF&(data))
#define  VBY1_DPHY_RD_get_e8b10b_running_disparity(data)                         (0x000000FF&(data))
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:24;
        RBus_UInt32  e8b10b_running_disparity:8;
    };
}vby1_dphy_rd_RBUS;
