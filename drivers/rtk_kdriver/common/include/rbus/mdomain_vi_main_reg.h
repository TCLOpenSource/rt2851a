/**
* @file Mac7p-DesignSpec-M_Domain_VI
...
#define  MDOMAIN_VI_MAIN_mdom_vi_c_line_step                                    0x1802706C
#define  MDOMAIN_VI_MAIN_mdom_vi_c_line_step_reg_addr                            "0xB802706C"
#define  MDOMAIN_VI_MAIN_mdom_vi_c_line_step_reg                                 0xB802706C
#define  MDOMAIN_VI_MAIN_mdom_vi_c_line_step_inst_addr                           "0x000E"
#define  set_MDOMAIN_VI_MAIN_mdom_vi_c_line_step_reg(data)                       (*((volatile unsigned int*)MDOMAIN_VI_MAIN_mdom_vi_c_line_step_reg)=data)
#define  get_MDOMAIN_VI_MAIN_mdom_vi_c_line_step_reg                             (*((volatile unsigned int*)MDOMAIN_VI_MAIN_mdom_vi_c_line_step_reg))
#define  MDOMAIN_VI_MAIN_mdom_vi_c_line_step_c_line_step_shift                   (3)
#define  MDOMAIN_VI_MAIN_mdom_vi_c_line_step_common_line_step_en_shift           (0)
#define  MDOMAIN_VI_MAIN_mdom_vi_c_line_step_c_line_step_mask                    (0xFFFFFFF8)
#define  MDOMAIN_VI_MAIN_mdom_vi_c_line_step_common_line_step_en_mask            (0x00000001)
#define  MDOMAIN_VI_MAIN_mdom_vi_c_line_step_c_line_step(data)                   (0xFFFFFFF8&((data)<<3))
#define  MDOMAIN_VI_MAIN_mdom_vi_c_line_step_common_line_step_en(data)           (0x00000001&(data))
#define  MDOMAIN_VI_MAIN_mdom_vi_c_line_step_get_c_line_step(data)               ((0xFFFFFFF8&(data))>>3)
#define  MDOMAIN_VI_MAIN_mdom_vi_c_line_step_get_common_line_step_en(data)       (0x00000001&(data))
...
#define  MDOMAIN_VI_MAIN_mdom_vi_doublebuffer_inst_addr                          "0x000F"
...
#define  MDOMAIN_VI_MAIN_mdom_vi_addcmd_transform_inst_addr                      "0x0010"
...
#define  MDOMAIN_VI_MAIN_mdom_vi_ads_start_y_inst_addr                           "0x0011"
...
#define  MDOMAIN_VI_MAIN_mdom_vi_ads_start_c_inst_addr                           "0x0012"
...
}mdomain_vi_main_mdom_vi_c_line_step_RBUS;
