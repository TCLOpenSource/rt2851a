/**
* @file Mac7p-DesignSpec-D-Domain_OSD_security
...
#define  OSD_SECURITY_OSD_SECURITY_osd_split_en_shift                            (1)
...
#define  OSD_SECURITY_OSD_SECURITY_osd_split_en_mask                             (0x00000002)
...
#define  OSD_SECURITY_OSD_SECURITY_osd_split_en(data)                            (0x00000002&((data)<<1))
...
#define  OSD_SECURITY_OSD_SECURITY_get_osd_split_en(data)                        ((0x00000002&(data))>>1)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_dummy_31_28_shift                 (28)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_d1_m3_shift                       (25)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_d1_m2_shift                       (22)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_d1_m1_shift                       (19)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_d1_m0_shift                       (16)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_osd1_gamma_zone_type_shift        (12)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_osd_gamma_position_shift          (8)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_dynamic_region_en_shift           (7)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_mixer_gamma2_en_shift             (6)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_mixer_osd3x3_en_shift             (5)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_mixer_gamma1_en_shift             (4)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_dummy_31_28_mask                  (0xF0000000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_d1_m3_mask                        (0x0E000000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_d1_m2_mask                        (0x01C00000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_d1_m1_mask                        (0x00380000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_d1_m0_mask                        (0x00070000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_osd1_gamma_zone_type_mask         (0x00003000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_osd_gamma_position_mask           (0x00000700)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_dynamic_region_en_mask            (0x00000080)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_mixer_gamma2_en_mask              (0x00000040)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_mixer_osd3x3_en_mask              (0x00000020)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_mixer_gamma1_en_mask              (0x00000010)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_dummy_31_28(data)                 (0xF0000000&((data)<<28))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_d1_m3(data)                       (0x0E000000&((data)<<25))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_d1_m2(data)                       (0x01C00000&((data)<<22))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_d1_m1(data)                       (0x00380000&((data)<<19))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_d1_m0(data)                       (0x00070000&((data)<<16))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_osd1_gamma_zone_type(data)        (0x00003000&((data)<<12))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_osd_gamma_position(data)          (0x00000700&((data)<<8))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_dynamic_region_en(data)           (0x00000080&((data)<<7))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_mixer_gamma2_en(data)             (0x00000040&((data)<<6))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_mixer_osd3x3_en(data)             (0x00000020&((data)<<5))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_mixer_gamma1_en(data)             (0x00000010&((data)<<4))
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_get_dummy_31_28(data)             ((0xF0000000&(data))>>28)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_get_d1_m3(data)                   ((0x0E000000&(data))>>25)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_get_d1_m2(data)                   ((0x01C00000&(data))>>22)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_get_d1_m1(data)                   ((0x00380000&(data))>>19)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_get_d1_m0(data)                   ((0x00070000&(data))>>16)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_get_osd1_gamma_zone_type(data)    ((0x00003000&(data))>>12)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_get_osd_gamma_position(data)      ((0x00000700&(data))>>8)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_get_dynamic_region_en(data)       ((0x00000080&(data))>>7)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_get_mixer_gamma2_en(data)         ((0x00000040&(data))>>6)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_get_mixer_osd3x3_en(data)         ((0x00000020&(data))>>5)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_CTRL2_get_mixer_gamma1_en(data)         ((0x00000010&(data))>>4)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_alpha_detect_sel_shift              (16)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_alpha_detect_sel_mask               (0x00030000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c3_sel_mask                         (0x00003000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c2_sel_mask                         (0x00000300)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c1_sel_mask                         (0x00000030)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c0_sel_mask                         (0x00000003)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_alpha_detect_sel(data)              (0x00030000&((data)<<16))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c3_sel(data)                        (0x00003000&((data)<<12))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c2_sel(data)                        (0x00000300&((data)<<8))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c1_sel(data)                        (0x00000030&((data)<<4))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c0_sel(data)                        (0x00000003&(data))
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_get_alpha_detect_sel(data)          ((0x00030000&(data))>>16)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_get_c3_sel(data)                    ((0x00003000&(data))>>12)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_get_c2_sel(data)                    ((0x00000300&(data))>>8)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_get_c1_sel(data)                    ((0x00000030&(data))>>4)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_get_c0_sel(data)                    (0x00000003&(data))
...
#define  OSD_SECURITY_OSD_SECURITY_GDMA_SWITCH_clut_layer_sel_shift              (10)
#define  OSD_SECURITY_OSD_SECURITY_GDMA_SWITCH_clut_layer_sel_mask               (0x00000C00)
#define  OSD_SECURITY_OSD_SECURITY_GDMA_SWITCH_clut_layer_sel(data)              (0x00000C00&((data)<<10))
#define  OSD_SECURITY_OSD_SECURITY_GDMA_SWITCH_get_clut_layer_sel(data)          ((0x00000C00&(data))>>10)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b1_inst_addr                            "0x000E"
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b2_inst_addr                            "0x000F"
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b3_inst_addr                            "0x0010"
...
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2               0x1802E67C
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_reg_addr       "0xB802E67C"
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_reg            0xB802E67C
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_inst_addr      "0x0011"
#define  set_OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_reg(data)  (*((volatile unsigned int*)OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_reg)=data)
#define  get_OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_reg        (*((volatile unsigned int*)OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_reg))
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d3_m3_shift    (28)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d3_m2_shift    (24)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d3_m1_shift    (20)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d3_m0_shift    (16)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d2_m3_shift    (12)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d2_m2_shift    (8)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d2_m1_shift    (4)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d2_m0_shift    (0)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d3_m3_mask     (0x70000000)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d3_m2_mask     (0x07000000)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d3_m1_mask     (0x00700000)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d3_m0_mask     (0x00070000)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d2_m3_mask     (0x00007000)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d2_m2_mask     (0x00000700)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d2_m1_mask     (0x00000070)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d2_m0_mask     (0x00000007)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d3_m3(data)    (0x70000000&((data)<<28))
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d3_m2(data)    (0x07000000&((data)<<24))
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d3_m1(data)    (0x00700000&((data)<<20))
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d3_m0(data)    (0x00070000&((data)<<16))
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d2_m3(data)    (0x00007000&((data)<<12))
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d2_m2(data)    (0x00000700&((data)<<8))
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d2_m1(data)    (0x00000070&((data)<<4))
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_d2_m0(data)    (0x00000007&(data))
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_get_d3_m3(data) ((0x70000000&(data))>>28)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_get_d3_m2(data) ((0x07000000&(data))>>24)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_get_d3_m1(data) ((0x00700000&(data))>>20)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_get_d3_m0(data) ((0x00070000&(data))>>16)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_get_d2_m3(data) ((0x00007000&(data))>>12)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_get_d2_m2(data) ((0x00000700&(data))>>8)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_get_d2_m1(data) ((0x00000070&(data))>>4)
#define  OSD_SECURITY_OSD_SECURITY_OSD_GAMMA_dynamic_region_D3_D2_get_d2_m0(data) (0x00000007&(data))

#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel                        0x1802E680
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_reg_addr                "0xB802E680"
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_reg                     0xB802E680
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_inst_addr               "0x0012"
#define  set_OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_reg(data)           (*((volatile unsigned int*)OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_reg)=data)
#define  get_OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_reg                 (*((volatile unsigned int*)OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_reg))
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_data_empty_a_shift      (24)
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_data_empty_r_shift      (16)
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_data_empty_g_shift      (8)
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_data_empty_b_shift      (0)
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_data_empty_a_mask       (0xFF000000)
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_data_empty_r_mask       (0x00FF0000)
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_data_empty_g_mask       (0x0000FF00)
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_data_empty_b_mask       (0x000000FF)
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_data_empty_a(data)      (0xFF000000&((data)<<24))
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_data_empty_r(data)      (0x00FF0000&((data)<<16))
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_data_empty_g(data)      (0x0000FF00&((data)<<8))
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_data_empty_b(data)      (0x000000FF&(data))
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_get_data_empty_a(data)  ((0xFF000000&(data))>>24)
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_get_data_empty_r(data)  ((0x00FF0000&(data))>>16)
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_get_data_empty_g(data)  ((0x0000FF00&(data))>>8)
#define  OSD_SECURITY_OSD_SECURITY_osd_split_empty_pixel_get_data_empty_b(data)  (0x000000FF&(data))
...
}osd_security_osd_security_osd_gamma_dynamic_region_d3_d2_RBUS;
...
}osd_security_osd_security_osd_split_empty_pixel_RBUS;
