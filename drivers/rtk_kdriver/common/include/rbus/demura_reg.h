/**
* @file Mac7p-DesignSpec-D-Domain_Demura
...
#define  DEMURA_DEMURA_DMA_CTRL_1_inst_addr                                      "0x0010"
...
#define  DEMURA_DEMURA_DMA_WRAP_ADDR_inst_addr                                   "0x0011"
...
#define  DEMURA_DEMURA_DMA_WRAP_LINE_STEP_inst_addr                              "0x0012"
...
#define  DEMURA_DEMURA_DMA_WRAP_LEN_inst_addr                                    "0x0013"
...
#define  DEMURA_DEMURA_DMA_WRAP_WORD_inst_addr                                   "0x0014"
...
#define  DEMURA_DEMURA_DMA_RULE_CHECK_UP_inst_addr                               "0x0015"
...
#define  DEMURA_DEMURA_DMA_RULE_CHECK_LOW_inst_addr                              "0x0016"
...
#define  DEMURA_DEMURA_DMA_CTRL_inst_addr                                        "0x0017"
...
#define  DEMURA_DEMURA_DMA_WRAP_ST1_inst_addr                                    "0x0018"
...
#define  DEMURA_DEMURA_DMA_WRAP_ST2_inst_addr                                    "0x0019"
...
#define  DEMURA_DEMURA_DMA_ST1_inst_addr                                         "0x001A"
...
#define  DEMURA_DEMURA_DMA_ST1_dma_data_water_mask                               (0x007F0000)
...
#define  DEMURA_DEMURA_DMA_ST1_dma_data_water(data)                              (0x007F0000&((data)<<16))
...
#define  DEMURA_DEMURA_DMA_ST1_get_dma_data_water(data)                          ((0x007F0000&(data))>>16)
...
#define  DEMURA_DEMURA_DMA_ST2_inst_addr                                         "0x001B"
...
#define  DEMURA_DEMURA_DMA_ST3_inst_addr                                         "0x001C"
...
#define  DEMURA_DEMURA_DMA_WATER_MONITOR_inst_addr                               "0x001D"
...
#define  DEMURA_DEMURA_DMA_WATER_MONITOR_monitor_thd_mask                        (0x007F0000)
#define  DEMURA_DEMURA_DMA_WATER_MONITOR_reach_thd_mask                          (0x00000100)
#define  DEMURA_DEMURA_DMA_WATER_MONITOR_lowest_water_level_mask                 (0x0000007F)
...
#define  DEMURA_DEMURA_DMA_WATER_MONITOR_monitor_thd(data)                       (0x007F0000&((data)<<16))
#define  DEMURA_DEMURA_DMA_WATER_MONITOR_reach_thd(data)                         (0x00000100&((data)<<8))
#define  DEMURA_DEMURA_DMA_WATER_MONITOR_lowest_water_level(data)                (0x0000007F&(data))
...
#define  DEMURA_DEMURA_DMA_WATER_MONITOR_get_monitor_thd(data)                   ((0x007F0000&(data))>>16)
#define  DEMURA_DEMURA_DMA_WATER_MONITOR_get_reach_thd(data)                     ((0x00000100&(data))>>8)
#define  DEMURA_DEMURA_DMA_WATER_MONITOR_get_lowest_water_level(data)            (0x0000007F&(data))
...
#define  DEMURA_DEMURA_DMA_BIST_1_inst_addr                                      "0x001E"
...
#define  DEMURA_DEMURA_DMA_BIST_2_inst_addr                                      "0x001F"
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  res1:7;
        RBus_UInt32  monitor_thd:7;
        RBus_UInt32  res2:7;
        RBus_UInt32  reach_thd:1;
        RBus_UInt32  res3:1;
        RBus_UInt32  lowest_water_level:7;
    };
