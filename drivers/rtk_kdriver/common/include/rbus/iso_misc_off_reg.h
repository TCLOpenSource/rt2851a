/**
* @file Mac7p-DesignSpec-ISO_MISC_OFF_arch_spec
...
#define  ISO_MISC_OFF_SYSTEM_i2c0_scpu_and_8051_int_sel_shift                    (28)
#define  ISO_MISC_OFF_SYSTEM_i2c0_scpu_and_8051_int_en_shift                     (26)
...
#define  ISO_MISC_OFF_SYSTEM_i2c0_scpu_and_8051_int_sel_mask                     (0x10000000)
#define  ISO_MISC_OFF_SYSTEM_i2c0_scpu_and_8051_int_en_mask                      (0x04000000)
...
#define  ISO_MISC_OFF_SYSTEM_i2c0_scpu_and_8051_int_sel(data)                    (0x10000000&((data)<<28))
#define  ISO_MISC_OFF_SYSTEM_i2c0_scpu_and_8051_int_en(data)                     (0x04000000&((data)<<26))
...
#define  ISO_MISC_OFF_SYSTEM_get_i2c0_scpu_and_8051_int_sel(data)                ((0x10000000&(data))>>28)
#define  ISO_MISC_OFF_SYSTEM_get_i2c0_scpu_and_8051_int_en(data)                 ((0x04000000&(data))>>26)
...
#define  ISO_MISC_OFF_INT_CTRL                                                  0x18062110
#define  ISO_MISC_OFF_INT_CTRL_reg_addr                                          "0xB8062110"
#define  ISO_MISC_OFF_INT_CTRL_reg                                               0xB8062110
#define  ISO_MISC_OFF_INT_CTRL_inst_addr                                         "0x0002"
#define  set_ISO_MISC_OFF_INT_CTRL_reg(data)                                     (*((volatile unsigned int*)ISO_MISC_OFF_INT_CTRL_reg)=data)
#define  get_ISO_MISC_OFF_INT_CTRL_reg                                           (*((volatile unsigned int*)ISO_MISC_OFF_INT_CTRL_reg))
#define  ISO_MISC_OFF_INT_CTRL_uart0_int_to_emcu_en_shift                        (1)
#define  ISO_MISC_OFF_INT_CTRL_uart0_int_to_scpu_en_shift                        (0)
#define  ISO_MISC_OFF_INT_CTRL_uart0_int_to_emcu_en_mask                         (0x00000002)
#define  ISO_MISC_OFF_INT_CTRL_uart0_int_to_scpu_en_mask                         (0x00000001)
#define  ISO_MISC_OFF_INT_CTRL_uart0_int_to_emcu_en(data)                        (0x00000002&((data)<<1))
#define  ISO_MISC_OFF_INT_CTRL_uart0_int_to_scpu_en(data)                        (0x00000001&(data))
#define  ISO_MISC_OFF_INT_CTRL_get_uart0_int_to_emcu_en(data)                    ((0x00000002&(data))>>1)
#define  ISO_MISC_OFF_INT_CTRL_get_uart0_int_to_scpu_en(data)                    (0x00000001&(data))
...
#define  ISO_MISC_OFF_DUMMY1_inst_addr                                           "0x0003"
...
#define  ISO_MISC_OFF_DUMMY2_inst_addr                                           "0x0004"
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:3;
        RBus_UInt32  i2c0_scpu_and_8051_int_sel:1;
        RBus_UInt32  res2:1;
        RBus_UInt32  i2c0_scpu_and_8051_int_en:1;
        RBus_UInt32  res3:6;
        RBus_UInt32  res4:3;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:30;
        RBus_UInt32  uart0_int_to_emcu_en:1;
        RBus_UInt32  uart0_int_to_scpu_en:1;
    };
