/**
* @file Mac7p-DesignSpec-I-Domain_AutoSOY
...
#define  AUTO_SOY_NO_TRIGGER_FLAG_reg_prev_glitch_st_en_shift                    (24)
...
#define  AUTO_SOY_NO_TRIGGER_FLAG_reg_prev_glitch_st_en_mask                     (0x01000000)
...
#define  AUTO_SOY_NO_TRIGGER_FLAG_reg_prev_glitch_st_en(data)                    (0x01000000&((data)<<24))
...
#define  AUTO_SOY_NO_TRIGGER_FLAG_get_reg_prev_glitch_st_en(data)                ((0x01000000&(data))>>24)
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:7;
        RBus_UInt32  reg_prev_glitch_st_en:1;
        RBus_UInt32  res2:2;
