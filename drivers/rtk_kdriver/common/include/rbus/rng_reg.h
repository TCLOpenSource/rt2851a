...
#define  RNG_eip76_ctrl_inst_addr                                                "0x000F"
...
#define  RNG_return6_inst_addr                                                   "0x0010"
...
#define  RNG_dummy_1fe4                                                         0x18001FE4
#define  RNG_dummy_1fe4_reg_addr                                                 "0xB8001FE4"
#define  RNG_dummy_1fe4_reg                                                      0xB8001FE4
#define  RNG_dummy_1fe4_inst_addr                                                "0x0011"
#define  set_RNG_dummy_1fe4_reg(data)                                            (*((volatile unsigned int*)RNG_dummy_1fe4_reg)=data)
#define  get_RNG_dummy_1fe4_reg                                                  (*((volatile unsigned int*)RNG_dummy_1fe4_reg))
#define  RNG_dummy_1fe4_dummy_1_shift                                            (0)
#define  RNG_dummy_1fe4_dummy_1_mask                                             (0xFFFFFFFF)
#define  RNG_dummy_1fe4_dummy_1(data)                                            (0xFFFFFFFF&(data))
#define  RNG_dummy_1fe4_get_dummy_1(data)                                        (0xFFFFFFFF&(data))
