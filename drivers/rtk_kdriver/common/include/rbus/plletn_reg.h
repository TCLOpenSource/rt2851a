...
#define  PLLETN_MAC_ASYNC_CTRL                                                  0x18016C08
#define  PLLETN_MAC_ASYNC_CTRL_reg_addr                                          "0xB8016C08"
#define  PLLETN_MAC_ASYNC_CTRL_reg                                               0xB8016C08
#define  PLLETN_MAC_ASYNC_CTRL_inst_addr                                         "0x0002"
#define  set_PLLETN_MAC_ASYNC_CTRL_reg(data)                                     (*((volatile unsigned int*)PLLETN_MAC_ASYNC_CTRL_reg)=data)
#define  get_PLLETN_MAC_ASYNC_CTRL_reg                                           (*((volatile unsigned int*)PLLETN_MAC_ASYNC_CTRL_reg))
#define  PLLETN_MAC_ASYNC_CTRL_gmac_async_gating_shift                           (1)
#define  PLLETN_MAC_ASYNC_CTRL_gmac_async_rstsel_shift                           (0)
#define  PLLETN_MAC_ASYNC_CTRL_gmac_async_gating_mask                            (0x00000002)
#define  PLLETN_MAC_ASYNC_CTRL_gmac_async_rstsel_mask                            (0x00000001)
#define  PLLETN_MAC_ASYNC_CTRL_gmac_async_gating(data)                           (0x00000002&((data)<<1))
#define  PLLETN_MAC_ASYNC_CTRL_gmac_async_rstsel(data)                           (0x00000001&(data))
#define  PLLETN_MAC_ASYNC_CTRL_get_gmac_async_gating(data)                       ((0x00000002&(data))>>1)
#define  PLLETN_MAC_ASYNC_CTRL_get_gmac_async_rstsel(data)                       (0x00000001&(data))

#define  PLLETN_WOW_CLK                                                         0x18016C10
#define  PLLETN_WOW_CLK_reg_addr                                                 "0xB8016C10"
#define  PLLETN_WOW_CLK_reg                                                      0xB8016C10
#define  PLLETN_WOW_CLK_inst_addr                                                "0x0003"
...
#define  PLLETN_WOW_DBG_inst_addr                                                "0x0004"
...
#define  PLLETN_WOW_DBG_sel_xtal27m_cen_l_shift                                  (5)
...
#define  PLLETN_WOW_DBG_sel_xtal27m_cen_l_mask                                   (0x00000020)
...
#define  PLLETN_WOW_DBG_sel_xtal27m_cen_l(data)                                  (0x00000020&((data)<<5))
...
#define  PLLETN_WOW_DBG_get_sel_xtal27m_cen_l(data)                              ((0x00000020&(data))>>5)
...
#define  PLLETN_SYS_PLL_ETN1_inst_addr                                           "0x0005"
...
#define  PLLETN_INIT_AUTOLOAD_DONE_inst_addr                                     "0x0006"
...
#define  PLLETN_ETN_ANALOG_PHY_inst_addr                                         "0x0007"
...
#define  PLLETN_ETN_phy_info_reg_inst_addr                                       "0x0008"
...
#define  PLLETN_ETN_phy_info_reg_por_dvth_cen_shift                              (2)
#define  PLLETN_ETN_phy_info_reg_por_avth_cen_shift                              (0)
#define  PLLETN_ETN_phy_info_reg_afe_pow_state_mask                              (0x20000000)
#define  PLLETN_ETN_phy_info_reg_por_dvth_cen_mask                               (0x0000000C)
#define  PLLETN_ETN_phy_info_reg_por_avth_cen_mask                               (0x00000003)
#define  PLLETN_ETN_phy_info_reg_afe_pow_state(data)                             (0x20000000&((data)<<29))
#define  PLLETN_ETN_phy_info_reg_por_dvth_cen(data)                              (0x0000000C&((data)<<2))
#define  PLLETN_ETN_phy_info_reg_por_avth_cen(data)                              (0x00000003&(data))
#define  PLLETN_ETN_phy_info_reg_get_afe_pow_state(data)                         ((0x20000000&(data))>>29)
#define  PLLETN_ETN_phy_info_reg_get_por_dvth_cen(data)                          ((0x0000000C&(data))>>2)
#define  PLLETN_ETN_phy_info_reg_get_por_avth_cen(data)                          (0x00000003&(data))
...
#define  PLLETN_sf_test_ctrl_inst_addr                                           "0x0009"
...
#define  PLLETN_sf_test_ctrl_sf_rx_debug_bit_sel_shift                           (7)
...
#define  PLLETN_sf_test_ctrl_sf_rx_debug_bit_sel_mask                            (0x00007F80)
...
#define  PLLETN_sf_test_ctrl_sf_rx_debug_bit_sel(data)                           (0x00007F80&((data)<<7))
...
#define  PLLETN_sf_test_ctrl_get_sf_rx_debug_bit_sel(data)                       ((0x00007F80&(data))>>7)
...
#define  PLLETN_sf_test_status_inst_addr                                         "0x000A"
...
#define  PLLETN_sf_test_status_reg_sf_rx_fail_bit_status_ro_shift                (6)
...
#define  PLLETN_sf_test_status_reg_sf_rx_fail_bit_status_ro_mask                 (0x00000040)
...
#define  PLLETN_sf_test_status_reg_sf_rx_fail_bit_status_ro(data)                (0x00000040&((data)<<6))
...
#define  PLLETN_sf_test_status_get_reg_sf_rx_fail_bit_status_ro(data)            ((0x00000040&(data))>>6)
...
#define  PLLETN_mp_cov_ctrl                                                     0x18016C48
#define  PLLETN_mp_cov_ctrl_reg_addr                                             "0xB8016C48"
#define  PLLETN_mp_cov_ctrl_reg                                                  0xB8016C48
#define  PLLETN_mp_cov_ctrl_inst_addr                                            "0x000B"
#define  set_PLLETN_mp_cov_ctrl_reg(data)                                        (*((volatile unsigned int*)PLLETN_mp_cov_ctrl_reg)=data)
#define  get_PLLETN_mp_cov_ctrl_reg                                              (*((volatile unsigned int*)PLLETN_mp_cov_ctrl_reg))
#define  PLLETN_mp_cov_ctrl_mp_cov_value_shift                                   (4)
#define  PLLETN_mp_cov_ctrl_mp_cov_mode_shift                                    (0)
#define  PLLETN_mp_cov_ctrl_mp_cov_value_mask                                    (0x00000010)
#define  PLLETN_mp_cov_ctrl_mp_cov_mode_mask                                     (0x00000001)
#define  PLLETN_mp_cov_ctrl_mp_cov_value(data)                                   (0x00000010&((data)<<4))
#define  PLLETN_mp_cov_ctrl_mp_cov_mode(data)                                    (0x00000001&(data))
#define  PLLETN_mp_cov_ctrl_get_mp_cov_value(data)                               ((0x00000010&(data))>>4)
#define  PLLETN_mp_cov_ctrl_get_mp_cov_mode(data)                                (0x00000001&(data))
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:30;
        RBus_UInt32  gmac_async_gating:1;
        RBus_UInt32  gmac_async_rstsel:1;
    };
}plletn_mac_async_ctrl_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:26;
        RBus_UInt32  sel_xtal27m_cen_l:1;
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  res4:16;
        RBus_UInt32  res5:4;
        RBus_UInt32  por_dvth_cen:2;
        RBus_UInt32  por_avth_cen:2;
    };
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:27;
        RBus_UInt32  mp_cov_value:1;
        RBus_UInt32  res2:3;
        RBus_UInt32  mp_cov_mode:1;
    };
}plletn_mp_cov_ctrl_RBUS;
