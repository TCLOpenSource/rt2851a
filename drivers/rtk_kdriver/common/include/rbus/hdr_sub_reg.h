...
#define  HDR_SUB_HDR2_BIST_MODE_hdr2_sram_test1(data)                            (0x00010000&((data)<<16))
...
#define  HDR_SUB_HDR2_BIST_MODE_get_hdr2_sram_test1(data)                        ((0x00010000&(data))>>16)
