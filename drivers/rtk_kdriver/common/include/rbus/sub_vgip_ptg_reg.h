...
#define  SUB_VGIP_PTG_CH2_PTG_CTRL_ch2_shift_size_mode_shift                     (21)
...
#define  SUB_VGIP_PTG_CH2_PTG_CTRL_ch2_shift_size_mode_mask                      (0x00200000)
...
#define  SUB_VGIP_PTG_CH2_PTG_CTRL_ch2_shift_size_mode(data)                     (0x00200000&((data)<<21))
...
#define  SUB_VGIP_PTG_CH2_PTG_CTRL_get_ch2_shift_size_mode(data)                 ((0x00200000&(data))>>21)
...
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width                                   0x180227E8
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_reg_addr                           "0xB80227E8"
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_reg                                0xB80227E8
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_inst_addr                          "0x0009"
#define  set_SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_reg(data)                      (*((volatile unsigned int*)SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_reg)=data)
#define  get_SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_reg                            (*((volatile unsigned int*)SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_reg))
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_ptg_ch2_ih_act_sta_shift           (16)
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_ptg_ch2_ih_act_wid_shift           (0)
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_ptg_ch2_ih_act_sta_mask            (0x3FFF0000)
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_ptg_ch2_ih_act_wid_mask            (0x00003FFF)
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_ptg_ch2_ih_act_sta(data)           (0x3FFF0000&((data)<<16))
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_ptg_ch2_ih_act_wid(data)           (0x00003FFF&(data))
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_get_ptg_ch2_ih_act_sta(data)       ((0x3FFF0000&(data))>>16)
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_HSTA_Width_get_ptg_ch2_ih_act_wid(data)       (0x00003FFF&(data))

#define  SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width                                   0x180227EC
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_reg_addr                           "0xB80227EC"
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_reg                                0xB80227EC
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_inst_addr                          "0x000A"
#define  set_SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_reg(data)                      (*((volatile unsigned int*)SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_reg)=data)
#define  get_SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_reg                            (*((volatile unsigned int*)SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_reg))
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_ptg_ch2_iv_act_sta_shift           (16)
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_ptg_ch2_iv_act_len_shift           (0)
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_ptg_ch2_iv_act_sta_mask            (0x3FFF0000)
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_ptg_ch2_iv_act_len_mask            (0x00003FFF)
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_ptg_ch2_iv_act_sta(data)           (0x3FFF0000&((data)<<16))
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_ptg_ch2_iv_act_len(data)           (0x00003FFF&(data))
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_get_ptg_ch2_iv_act_sta(data)       ((0x3FFF0000&(data))>>16)
#define  SUB_VGIP_PTG_PTG_CHN2_ACT_VSTA_Width_get_ptg_ch2_iv_act_len(data)       (0x00003FFF&(data))
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  ch2_shift_size_mode:1;
        RBus_UInt32  res2:13;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:2;
        RBus_UInt32  ptg_ch2_ih_act_sta:14;
        RBus_UInt32  res2:2;
        RBus_UInt32  ptg_ch2_ih_act_wid:14;
    };
}sub_vgip_ptg_ptg_chn2_act_hsta_width_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:2;
        RBus_UInt32  ptg_ch2_iv_act_sta:14;
        RBus_UInt32  res2:2;
        RBus_UInt32  ptg_ch2_iv_act_len:14;
    };
}sub_vgip_ptg_ptg_chn2_act_vsta_width_RBUS;
