...
#define  DITHER_DITHERING_CTRL3                                                 0x1802C640
#define  DITHER_DITHERING_CTRL3_reg_addr                                         "0xB802C640"
#define  DITHER_DITHERING_CTRL3_reg                                              0xB802C640
#define  DITHER_DITHERING_CTRL3_inst_addr                                        "0x004C"
#define  set_DITHER_DITHERING_CTRL3_reg(data)                                    (*((volatile unsigned int*)DITHER_DITHERING_CTRL3_reg)=data)
#define  get_DITHER_DITHERING_CTRL3_reg                                          (*((volatile unsigned int*)DITHER_DITHERING_CTRL3_reg))
#define  DITHER_DITHERING_CTRL3_dither_oled_th_en_shift                          (31)
#define  DITHER_DITHERING_CTRL3_dither_oled_th_shift                             (0)
#define  DITHER_DITHERING_CTRL3_dither_oled_th_en_mask                           (0x80000000)
#define  DITHER_DITHERING_CTRL3_dither_oled_th_mask                              (0x00000FFF)
#define  DITHER_DITHERING_CTRL3_dither_oled_th_en(data)                          (0x80000000&((data)<<31))
#define  DITHER_DITHERING_CTRL3_dither_oled_th(data)                             (0x00000FFF&(data))
#define  DITHER_DITHERING_CTRL3_get_dither_oled_th_en(data)                      ((0x80000000&(data))>>31)
#define  DITHER_DITHERING_CTRL3_get_dither_oled_th(data)                         (0x00000FFF&(data))
...
typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  dither_oled_th_en:1;
        RBus_UInt32  res1:19;
        RBus_UInt32  dither_oled_th:12;
    };
}dither_dithering_ctrl3_RBUS;
