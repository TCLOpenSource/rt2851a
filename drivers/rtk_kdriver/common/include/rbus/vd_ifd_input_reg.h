/**
* @file Mac7p-DesignSpec_vd_ifd_input
...
#define  VD_IFD_INPUT_CRC_EN_vd_read_only_shift                                  (31)
#define  VD_IFD_INPUT_CRC_EN_crc_108mhz_en_shift                                 (0)
#define  VD_IFD_INPUT_CRC_EN_vd_read_only_mask                                   (0x80000000)
#define  VD_IFD_INPUT_CRC_EN_crc_108mhz_en_mask                                  (0x00000001)
#define  VD_IFD_INPUT_CRC_EN_vd_read_only(data)                                  (0x80000000&((data)<<31))
#define  VD_IFD_INPUT_CRC_EN_crc_108mhz_en(data)                                 (0x00000001&(data))
#define  VD_IFD_INPUT_CRC_EN_get_vd_read_only(data)                              ((0x80000000&(data))>>31)
