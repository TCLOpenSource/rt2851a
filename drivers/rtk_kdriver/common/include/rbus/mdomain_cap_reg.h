/**
* @file Mac7p-DesignSpec-M_Domain_Cap1Cap2
...
#define  MDOMAIN_CAP_DDR_In1Ctrl_in1_block_upatvs_en_shift                       (19)
...
#define  MDOMAIN_CAP_DDR_In1Ctrl_in1_block_upatvs_en_mask                        (0x00080000)
...
#define  MDOMAIN_CAP_DDR_In1Ctrl_in1_block_upatvs_en(data)                       (0x00080000&((data)<<19))
...
#define  MDOMAIN_CAP_DDR_In1Ctrl_get_in1_block_upatvs_en(data)                   ((0x00080000&(data))>>19)
...
#define  MDOMAIN_CAP_DDR_In2Ctrl_in2_block_upatvs_en_shift                       (19)
...
#define  MDOMAIN_CAP_DDR_In2Ctrl_in2_block_upatvs_en_mask                        (0x00080000)
...
#define  MDOMAIN_CAP_DDR_In2Ctrl_in2_block_upatvs_en(data)                       (0x00080000&((data)<<19))
...
#define  MDOMAIN_CAP_DDR_In2Ctrl_get_in2_block_upatvs_en(data)                   ((0x00080000&(data))>>19)
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  in1_block_upatvs_en:1;
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  in2_block_upatvs_en:1;
