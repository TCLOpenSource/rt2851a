/**
* @file Mac7p-DesignSpec-I-Domain_ADC_SmartFIT
...
#define  ADC_SMARTFIT_ADC_AUTO_PHASE_CTRL0_para_ap_en_shift                      (30)
...
#define  ADC_SMARTFIT_ADC_AUTO_PHASE_CTRL0_para_ap_en_mask                       (0x40000000)
...
#define  ADC_SMARTFIT_ADC_AUTO_PHASE_CTRL0_para_ap_en(data)                      (0x40000000&((data)<<30))
...
#define  ADC_SMARTFIT_ADC_AUTO_PHASE_CTRL0_get_para_ap_en(data)                  ((0x40000000&(data))>>30)
