/**
* @file Mac7p-DesignSpec-ISO_MISC_OFF_WDOG
...
#define  WDOG_TCWCR_upper_bound_sel_shift                                        (20)
#define  WDOG_TCWCR_wd_rst_src_shift                                             (17)
...
#define  WDOG_TCWCR_upper_bound_sel_mask                                         (0x00100000)
#define  WDOG_TCWCR_wd_rst_src_mask                                              (0x00060000)
...
#define  WDOG_TCWCR_upper_bound_sel(data)                                        (0x00100000&((data)<<20))
#define  WDOG_TCWCR_wd_rst_src(data)                                             (0x00060000&((data)<<17))
...
#define  WDOG_TCWCR_get_upper_bound_sel(data)                                    ((0x00100000&(data))>>20)
#define  WDOG_TCWCR_get_wd_rst_src(data)                                         ((0x00060000&(data))>>17)
...
#define  WDOG_TCWTRG                                                            0x18062214
#define  WDOG_TCWTRG_reg_addr                                                    "0xB8062214"
#define  WDOG_TCWTRG_reg                                                         0xB8062214
#define  WDOG_TCWTRG_inst_addr                                                   "0x0005"
#define  set_WDOG_TCWTRG_reg(data)                                               (*((volatile unsigned int*)WDOG_TCWTRG_reg)=data)
#define  get_WDOG_TCWTRG_reg                                                     (*((volatile unsigned int*)WDOG_TCWTRG_reg))
#define  WDOG_TCWTRG_te_shift                                                    (0)
#define  WDOG_TCWTRG_te_mask                                                     (0x00000001)
#define  WDOG_TCWTRG_te(data)                                                    (0x00000001&(data))
#define  WDOG_TCWTRG_get_te(data)                                                (0x00000001&(data))

#define  WDOG_TCWSTS                                                            0x18062218
#define  WDOG_TCWSTS_reg_addr                                                    "0xB8062218"
#define  WDOG_TCWSTS_reg                                                         0xB8062218
#define  WDOG_TCWSTS_inst_addr                                                   "0x0006"
#define  set_WDOG_TCWSTS_reg(data)                                               (*((volatile unsigned int*)WDOG_TCWSTS_reg)=data)
#define  get_WDOG_TCWSTS_reg                                                     (*((volatile unsigned int*)WDOG_TCWSTS_reg))
#define  WDOG_TCWSTS_wd_cnt_shift                                                (0)
#define  WDOG_TCWSTS_wd_cnt_mask                                                 (0xFFFFFFFF)
#define  WDOG_TCWSTS_wd_cnt(data)                                                (0xFFFFFFFF&(data))
#define  WDOG_TCWSTS_get_wd_cnt(data)                                            (0xFFFFFFFF&(data))
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  res1:10;
        RBus_UInt32  upper_bound_sel:1;
        RBus_UInt32  res2:1;
        RBus_UInt32  wd_rst_src:2;
        RBus_UInt32  wdie:1;
        RBus_UInt32  nmic:4;
        RBus_UInt32  wdc:4;
        RBus_UInt32  wden:8;
