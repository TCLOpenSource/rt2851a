/**
* @file Mac7p-DesignSpec-D-domain_Local_Dimming_interface
...
#define  LDSPI_Out_data_form_data_sram_separate_mask                             (0x000000FF)
...
#define  LDSPI_Out_data_form_data_sram_separate(data)                            (0x000000FF&(data))
...
#define  LDSPI_Out_data_form_get_data_sram_separate(data)                        (0x000000FF&(data))
...
#define  LDSPI_Outindex_Addr_CTRL_outindex_rw_pointer_set_mask                   (0x01FF0000)
#define  LDSPI_Outindex_Addr_CTRL_outindex_rw_pointer_mask                       (0x000001FF)
#define  LDSPI_Outindex_Addr_CTRL_outindex_rw_pointer_set(data)                  (0x01FF0000&((data)<<16))
#define  LDSPI_Outindex_Addr_CTRL_outindex_rw_pointer(data)                      (0x000001FF&(data))
#define  LDSPI_Outindex_Addr_CTRL_get_outindex_rw_pointer_set(data)              ((0x01FF0000&(data))>>16)
#define  LDSPI_Outindex_Addr_CTRL_get_outindex_rw_pointer(data)                  (0x000001FF&(data))
...
#define  LDSPI_Outindex_Rwport_outindex_rw_data_port_mask                        (0x000001FF)
#define  LDSPI_Outindex_Rwport_outindex_rw_data_port(data)                       (0x000001FF&(data))
#define  LDSPI_Outindex_Rwport_get_outindex_rw_data_port(data)                   (0x000001FF&(data))
...
#define  LDSPI_Data_Addr_CTRL_data_rw_pointer_set_mask                           (0x01FF0000)
#define  LDSPI_Data_Addr_CTRL_data_rw_pointer_mask                               (0x000001FF)
#define  LDSPI_Data_Addr_CTRL_data_rw_pointer_set(data)                          (0x01FF0000&((data)<<16))
#define  LDSPI_Data_Addr_CTRL_data_rw_pointer(data)                              (0x000001FF&(data))
#define  LDSPI_Data_Addr_CTRL_get_data_rw_pointer_set(data)                      ((0x01FF0000&(data))>>16)
#define  LDSPI_Data_Addr_CTRL_get_data_rw_pointer(data)                          (0x000001FF&(data))
...
#define  LDSPI_Data_SRAM_SPECIAL_CTRL_0_vrepeat_width_mask                       (0x1FF00000)
...
#define  LDSPI_Data_SRAM_SPECIAL_CTRL_0_vrepeat_width(data)                      (0x1FF00000&((data)<<20))
...
#define  LDSPI_Data_SRAM_SPECIAL_CTRL_0_get_vrepeat_width(data)                  ((0x1FF00000&(data))>>20)
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  res2:4;
        RBus_UInt32  data_sram_separate:8;
    };
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:7;
        RBus_UInt32  outindex_rw_pointer_set:9;
        RBus_UInt32  res2:7;
        RBus_UInt32  outindex_rw_pointer:9;
    };
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:23;
        RBus_UInt32  outindex_rw_data_port:9;
    };
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:7;
        RBus_UInt32  data_rw_pointer_set:9;
        RBus_UInt32  res2:7;
        RBus_UInt32  data_rw_pointer:9;
    };
