/**
* @file Mac7p-DesignSpec-SCPU_Wrapper_Spec
...
#define  SCPU_WRAPPER_swrap_bist_fail_group                                     0x1805C74C
#define  SCPU_WRAPPER_swrap_bist_fail_group_reg_addr                             "0xB805C74C"
#define  SCPU_WRAPPER_swrap_bist_fail_group_reg                                  0xB805C74C
#define  SCPU_WRAPPER_swrap_bist_fail_group_inst_addr                            "0x0032"
#define  set_SCPU_WRAPPER_swrap_bist_fail_group_reg(data)                        (*((volatile unsigned int*)SCPU_WRAPPER_swrap_bist_fail_group_reg)=data)
#define  get_SCPU_WRAPPER_swrap_bist_fail_group_reg                              (*((volatile unsigned int*)SCPU_WRAPPER_swrap_bist_fail_group_reg))
#define  SCPU_WRAPPER_swrap_bist_fail_group_bist_fail_shift                      (1)
#define  SCPU_WRAPPER_swrap_bist_fail_group_bist_fail_group_shift                (0)
#define  SCPU_WRAPPER_swrap_bist_fail_group_bist_fail_mask                       (0x0000000E)
#define  SCPU_WRAPPER_swrap_bist_fail_group_bist_fail_group_mask                 (0x00000001)
#define  SCPU_WRAPPER_swrap_bist_fail_group_bist_fail(data)                      (0x0000000E&((data)<<1))
#define  SCPU_WRAPPER_swrap_bist_fail_group_bist_fail_group(data)                (0x00000001&(data))
#define  SCPU_WRAPPER_swrap_bist_fail_group_get_bist_fail(data)                  ((0x0000000E&(data))>>1)
#define  SCPU_WRAPPER_swrap_bist_fail_group_get_bist_fail_group(data)            (0x00000001&(data))
...
#define  SCPU_WRAPPER_swrap_drf_bist_fail_group                                 0x1805C760
#define  SCPU_WRAPPER_swrap_drf_bist_fail_group_reg_addr                         "0xB805C760"
#define  SCPU_WRAPPER_swrap_drf_bist_fail_group_reg                              0xB805C760
#define  SCPU_WRAPPER_swrap_drf_bist_fail_group_inst_addr                        "0x0037"
#define  set_SCPU_WRAPPER_swrap_drf_bist_fail_group_reg(data)                    (*((volatile unsigned int*)SCPU_WRAPPER_swrap_drf_bist_fail_group_reg)=data)
#define  get_SCPU_WRAPPER_swrap_drf_bist_fail_group_reg                          (*((volatile unsigned int*)SCPU_WRAPPER_swrap_drf_bist_fail_group_reg))
#define  SCPU_WRAPPER_swrap_drf_bist_fail_group_drf_bist_fail_shift              (1)
#define  SCPU_WRAPPER_swrap_drf_bist_fail_group_drf_bist_fail_group_shift        (0)
#define  SCPU_WRAPPER_swrap_drf_bist_fail_group_drf_bist_fail_mask               (0x0000000E)
#define  SCPU_WRAPPER_swrap_drf_bist_fail_group_drf_bist_fail_group_mask         (0x00000001)
#define  SCPU_WRAPPER_swrap_drf_bist_fail_group_drf_bist_fail(data)              (0x0000000E&((data)<<1))
#define  SCPU_WRAPPER_swrap_drf_bist_fail_group_drf_bist_fail_group(data)        (0x00000001&(data))
#define  SCPU_WRAPPER_swrap_drf_bist_fail_group_get_drf_bist_fail(data)          ((0x0000000E&(data))>>1)
#define  SCPU_WRAPPER_swrap_drf_bist_fail_group_get_drf_bist_fail_group(data)    (0x00000001&(data))
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:28;
        RBus_UInt32  bist_fail:3;
        RBus_UInt32  bist_fail_group:1;
    };
}scpu_wrapper_swrap_bist_fail_group_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:28;
        RBus_UInt32  drf_bist_fail:3;
        RBus_UInt32  drf_bist_fail_group:1;
    };
}scpu_wrapper_swrap_drf_bist_fail_group_RBUS;
