/**
* @file Mac7p-DesignSpec-TOP_BIST
...
#define  TOPBIST_afbc_line_buffer_bisr_rstn                                     0x18000F04
#define  TOPBIST_afbc_line_buffer_bisr_rstn_reg_addr                             "0xB8000F04"
#define  TOPBIST_afbc_line_buffer_bisr_rstn_reg                                  0xB8000F04
#define  TOPBIST_afbc_line_buffer_bisr_rstn_inst_addr                            "0x0001"
#define  set_TOPBIST_afbc_line_buffer_bisr_rstn_reg(data)                        (*((volatile unsigned int*)TOPBIST_afbc_line_buffer_bisr_rstn_reg)=data)
#define  get_TOPBIST_afbc_line_buffer_bisr_rstn_reg                              (*((volatile unsigned int*)TOPBIST_afbc_line_buffer_bisr_rstn_reg))
#define  TOPBIST_afbc_line_buffer_bisr_rstn_afbc_line_buffer_bisr_rstn_shift     (0)
#define  TOPBIST_afbc_line_buffer_bisr_rstn_afbc_line_buffer_bisr_rstn_mask      (0x00000001)
#define  TOPBIST_afbc_line_buffer_bisr_rstn_afbc_line_buffer_bisr_rstn(data)     (0x00000001&(data))
#define  TOPBIST_afbc_line_buffer_bisr_rstn_get_afbc_line_buffer_bisr_rstn(data) (0x00000001&(data))
...
#define  TOPBIST_ve_bisr_rstn_inst_addr                                          "0x0002"
...
#define  TOPBIST_afbc_line_buffer_bisr_remap                                    0x18000F14
#define  TOPBIST_afbc_line_buffer_bisr_remap_reg_addr                            "0xB8000F14"
#define  TOPBIST_afbc_line_buffer_bisr_remap_reg                                 0xB8000F14
#define  TOPBIST_afbc_line_buffer_bisr_remap_inst_addr                           "0x0005"
#define  set_TOPBIST_afbc_line_buffer_bisr_remap_reg(data)                       (*((volatile unsigned int*)TOPBIST_afbc_line_buffer_bisr_remap_reg)=data)
#define  get_TOPBIST_afbc_line_buffer_bisr_remap_reg                             (*((volatile unsigned int*)TOPBIST_afbc_line_buffer_bisr_remap_reg))
#define  TOPBIST_afbc_line_buffer_bisr_remap_afbc_line_buffer_bisr_remap_shift   (0)
#define  TOPBIST_afbc_line_buffer_bisr_remap_afbc_line_buffer_bisr_remap_mask    (0x00000001)
#define  TOPBIST_afbc_line_buffer_bisr_remap_afbc_line_buffer_bisr_remap(data)   (0x00000001&(data))
#define  TOPBIST_afbc_line_buffer_bisr_remap_get_afbc_line_buffer_bisr_remap(data) (0x00000001&(data))
...
#define  TOPBIST_ve_bisr_remap_inst_addr                                         "0x0006"
...
#define  TOPBIST_afbc_line_buffer_bisr_done                                     0x18000F24
#define  TOPBIST_afbc_line_buffer_bisr_done_reg_addr                             "0xB8000F24"
#define  TOPBIST_afbc_line_buffer_bisr_done_reg                                  0xB8000F24
#define  TOPBIST_afbc_line_buffer_bisr_done_inst_addr                            "0x0009"
#define  set_TOPBIST_afbc_line_buffer_bisr_done_reg(data)                        (*((volatile unsigned int*)TOPBIST_afbc_line_buffer_bisr_done_reg)=data)
#define  get_TOPBIST_afbc_line_buffer_bisr_done_reg                              (*((volatile unsigned int*)TOPBIST_afbc_line_buffer_bisr_done_reg))
#define  TOPBIST_afbc_line_buffer_bisr_done_afbc_line_buffer_bisr_done_shift     (0)
#define  TOPBIST_afbc_line_buffer_bisr_done_afbc_line_buffer_bisr_done_mask      (0x00000001)
#define  TOPBIST_afbc_line_buffer_bisr_done_afbc_line_buffer_bisr_done(data)     (0x00000001&(data))
#define  TOPBIST_afbc_line_buffer_bisr_done_get_afbc_line_buffer_bisr_done(data) (0x00000001&(data))
...
#define  TOPBIST_ve_bisr_done_inst_addr                                          "0x000A"
...
#define  TOPBIST_wov_bisr_rstn                                                  0x18000F50
#define  TOPBIST_wov_bisr_rstn_reg_addr                                          "0xB8000F50"
#define  TOPBIST_wov_bisr_rstn_reg                                               0xB8000F50
#define  TOPBIST_wov_bisr_rstn_inst_addr                                         "0x000E"
#define  set_TOPBIST_wov_bisr_rstn_reg(data)                                     (*((volatile unsigned int*)TOPBIST_wov_bisr_rstn_reg)=data)
#define  get_TOPBIST_wov_bisr_rstn_reg                                           (*((volatile unsigned int*)TOPBIST_wov_bisr_rstn_reg))
#define  TOPBIST_wov_bisr_rstn_wov_bisr_rstn_shift                               (0)
#define  TOPBIST_wov_bisr_rstn_wov_bisr_rstn_mask                                (0x00000001)
#define  TOPBIST_wov_bisr_rstn_wov_bisr_rstn(data)                               (0x00000001&(data))
#define  TOPBIST_wov_bisr_rstn_get_wov_bisr_rstn(data)                           (0x00000001&(data))

#define  TOPBIST_wov_bisr_remap                                                 0x18000F54
#define  TOPBIST_wov_bisr_remap_reg_addr                                         "0xB8000F54"
#define  TOPBIST_wov_bisr_remap_reg                                              0xB8000F54
#define  TOPBIST_wov_bisr_remap_inst_addr                                        "0x000F"
#define  set_TOPBIST_wov_bisr_remap_reg(data)                                    (*((volatile unsigned int*)TOPBIST_wov_bisr_remap_reg)=data)
#define  get_TOPBIST_wov_bisr_remap_reg                                          (*((volatile unsigned int*)TOPBIST_wov_bisr_remap_reg))
#define  TOPBIST_wov_bisr_remap_wov_bisr_remap_shift                             (0)
#define  TOPBIST_wov_bisr_remap_wov_bisr_remap_mask                              (0x00000001)
#define  TOPBIST_wov_bisr_remap_wov_bisr_remap(data)                             (0x00000001&(data))
#define  TOPBIST_wov_bisr_remap_get_wov_bisr_remap(data)                         (0x00000001&(data))

#define  TOPBIST_wov_bisr_done                                                  0x18000F58
#define  TOPBIST_wov_bisr_done_reg_addr                                          "0xB8000F58"
#define  TOPBIST_wov_bisr_done_reg                                               0xB8000F58
#define  TOPBIST_wov_bisr_done_inst_addr                                         "0x0010"
#define  set_TOPBIST_wov_bisr_done_reg(data)                                     (*((volatile unsigned int*)TOPBIST_wov_bisr_done_reg)=data)
#define  get_TOPBIST_wov_bisr_done_reg                                           (*((volatile unsigned int*)TOPBIST_wov_bisr_done_reg))
#define  TOPBIST_wov_bisr_done_wov_bisr_done_shift                               (0)
#define  TOPBIST_wov_bisr_done_wov_bisr_done_mask                                (0x00000001)
#define  TOPBIST_wov_bisr_done_wov_bisr_done(data)                               (0x00000001&(data))
#define  TOPBIST_wov_bisr_done_get_wov_bisr_done(data)                           (0x00000001&(data))
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:31;
        RBus_UInt32  afbc_line_buffer_bisr_rstn:1;
    };
}topbist_afbc_line_buffer_bisr_rstn_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:31;
        RBus_UInt32  afbc_line_buffer_bisr_remap:1;
    };
}topbist_afbc_line_buffer_bisr_remap_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:31;
        RBus_UInt32  afbc_line_buffer_bisr_done:1;
    };
}topbist_afbc_line_buffer_bisr_done_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:31;
        RBus_UInt32  wov_bisr_rstn:1;
    };
}topbist_wov_bisr_rstn_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:31;
        RBus_UInt32  wov_bisr_remap:1;
    };
}topbist_wov_bisr_remap_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:31;
        RBus_UInt32  wov_bisr_done:1;
    };
}topbist_wov_bisr_done_RBUS;
