...
#define  EMMC_WRAP_FOR_CP_TEST                                                  0x180108C4
#define  EMMC_WRAP_FOR_CP_TEST_reg_addr                                          "0xB80108C4"
#define  EMMC_WRAP_FOR_CP_TEST_reg                                               0xB80108C4
#define  EMMC_WRAP_FOR_CP_TEST_inst_addr                                         "0x0024"
#define  set_EMMC_WRAP_FOR_CP_TEST_reg(data)                                     (*((volatile unsigned int*)EMMC_WRAP_FOR_CP_TEST_reg)=data)
#define  get_EMMC_WRAP_FOR_CP_TEST_reg                                           (*((volatile unsigned int*)EMMC_WRAP_FOR_CP_TEST_reg))
#define  EMMC_WRAP_FOR_CP_TEST_cp_test_enable_shift                              (31)
#define  EMMC_WRAP_FOR_CP_TEST_test_clk_out_shift                                (30)
#define  EMMC_WRAP_FOR_CP_TEST_test_rst_out_shift                                (29)
#define  EMMC_WRAP_FOR_CP_TEST_test_ds_in_shift                                  (28)
#define  EMMC_WRAP_FOR_CP_TEST_test_cmd_out_en_shift                             (26)
#define  EMMC_WRAP_FOR_CP_TEST_test_cmd_out_shift                                (25)
#define  EMMC_WRAP_FOR_CP_TEST_test_cmd_in_shift                                 (24)
#define  EMMC_WRAP_FOR_CP_TEST_test_data_out_en_shift                            (16)
#define  EMMC_WRAP_FOR_CP_TEST_test_data_out_shift                               (8)
#define  EMMC_WRAP_FOR_CP_TEST_test_data_in_shift                                (0)
#define  EMMC_WRAP_FOR_CP_TEST_cp_test_enable_mask                               (0x80000000)
#define  EMMC_WRAP_FOR_CP_TEST_test_clk_out_mask                                 (0x40000000)
#define  EMMC_WRAP_FOR_CP_TEST_test_rst_out_mask                                 (0x20000000)
#define  EMMC_WRAP_FOR_CP_TEST_test_ds_in_mask                                   (0x10000000)
#define  EMMC_WRAP_FOR_CP_TEST_test_cmd_out_en_mask                              (0x04000000)
#define  EMMC_WRAP_FOR_CP_TEST_test_cmd_out_mask                                 (0x02000000)
#define  EMMC_WRAP_FOR_CP_TEST_test_cmd_in_mask                                  (0x01000000)
#define  EMMC_WRAP_FOR_CP_TEST_test_data_out_en_mask                             (0x00FF0000)
#define  EMMC_WRAP_FOR_CP_TEST_test_data_out_mask                                (0x0000FF00)
#define  EMMC_WRAP_FOR_CP_TEST_test_data_in_mask                                 (0x000000FF)
#define  EMMC_WRAP_FOR_CP_TEST_cp_test_enable(data)                              (0x80000000&((data)<<31))
#define  EMMC_WRAP_FOR_CP_TEST_test_clk_out(data)                                (0x40000000&((data)<<30))
#define  EMMC_WRAP_FOR_CP_TEST_test_rst_out(data)                                (0x20000000&((data)<<29))
#define  EMMC_WRAP_FOR_CP_TEST_test_ds_in(data)                                  (0x10000000&((data)<<28))
#define  EMMC_WRAP_FOR_CP_TEST_test_cmd_out_en(data)                             (0x04000000&((data)<<26))
#define  EMMC_WRAP_FOR_CP_TEST_test_cmd_out(data)                                (0x02000000&((data)<<25))
#define  EMMC_WRAP_FOR_CP_TEST_test_cmd_in(data)                                 (0x01000000&((data)<<24))
#define  EMMC_WRAP_FOR_CP_TEST_test_data_out_en(data)                            (0x00FF0000&((data)<<16))
#define  EMMC_WRAP_FOR_CP_TEST_test_data_out(data)                               (0x0000FF00&((data)<<8))
#define  EMMC_WRAP_FOR_CP_TEST_test_data_in(data)                                (0x000000FF&(data))
#define  EMMC_WRAP_FOR_CP_TEST_get_cp_test_enable(data)                          ((0x80000000&(data))>>31)
#define  EMMC_WRAP_FOR_CP_TEST_get_test_clk_out(data)                            ((0x40000000&(data))>>30)
#define  EMMC_WRAP_FOR_CP_TEST_get_test_rst_out(data)                            ((0x20000000&(data))>>29)
#define  EMMC_WRAP_FOR_CP_TEST_get_test_ds_in(data)                              ((0x10000000&(data))>>28)
#define  EMMC_WRAP_FOR_CP_TEST_get_test_cmd_out_en(data)                         ((0x04000000&(data))>>26)
#define  EMMC_WRAP_FOR_CP_TEST_get_test_cmd_out(data)                            ((0x02000000&(data))>>25)
#define  EMMC_WRAP_FOR_CP_TEST_get_test_cmd_in(data)                             ((0x01000000&(data))>>24)
#define  EMMC_WRAP_FOR_CP_TEST_get_test_data_out_en(data)                        ((0x00FF0000&(data))>>16)
#define  EMMC_WRAP_FOR_CP_TEST_get_test_data_out(data)                           ((0x0000FF00&(data))>>8)
#define  EMMC_WRAP_FOR_CP_TEST_get_test_data_in(data)                            (0x000000FF&(data))
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  test_clk_out:1;
        RBus_UInt32  test_rst_out:1;
        RBus_UInt32  test_ds_in:1;
        RBus_UInt32  res1:1;
        RBus_UInt32  test_cmd_out_en:1;
        RBus_UInt32  test_cmd_out:1;
        RBus_UInt32  test_cmd_in:1;
        RBus_UInt32  test_data_out_en:8;
        RBus_UInt32  test_data_out:8;
        RBus_UInt32  test_data_in:8;
    };
}emmc_wrap_for_cp_test_RBUS;
