...
#define  LR_LR_CTRL_inst_adr                                                     "0x00A0"
#define  LR_LR_CTRL_inst                                                         0x00A0
...
#define  LR_LR_CTRL_lr_wdone_1t_after_wlast_src(data)                            ((0x00000008&(data))>>3)
#define  LR_LR_CTRL_lr_reset_src(data)                                           ((0x00000004&(data))>>2)
#define  LR_LR_CTRL_lr_done_src(data)                                            ((0x00000002&(data))>>1)
#define  LR_LR_CTRL_lr_busy_src(data)                                            (0x00000001&(data))
...
#define  LR_LR_VM0_inst_adr                                                      "0x00A1"
#define  LR_LR_VM0_inst                                                          0x00A1
...
#define  LR_LR_VM0_vm_basea0_src(data)                                           ((0x0FE00000&(data))>>21)
#define  LR_LR_VM0_vm_basea1_src(data)                                           ((0x001FC000&(data))>>14)
#define  LR_LR_VM0_vm_sb_adr_src(data)                                           (0x0000003F&(data))
...
#define  LR_LR_VM1_inst_adr                                                      "0x00A2"
#define  LR_LR_VM1_inst                                                          0x00A2
...
#define  LR_LR_VM1_vm_offseta0_src(data)                                         ((0x003F0000&(data))>>16)
#define  LR_LR_VM1_vm_offseta1_src(data)                                         (0x0000003F&(data))
...
#define  LR_LU_LR_PARM_DMA_inst_adr                                              "0x00A3"
#define  LR_LU_LR_PARM_DMA_inst                                                  0x00A3
...
#define  LR_LU_LR_PARM_DMA_lu_parm_dma_busy_src(data)                            ((0x80000000&(data))>>31)
#define  LR_LU_LR_PARM_DMA_lu_parm_dma_adr_src(data)                             (0x7FFFFFFF&(data))
...
#define  LR_CB_LR_PARM_DMA_inst_adr                                              "0x00A4"
#define  LR_CB_LR_PARM_DMA_inst                                                  0x00A4
...
#define  LR_CB_LR_PARM_DMA_cb_parm_dma_busy_src(data)                            ((0x80000000&(data))>>31)
#define  LR_CB_LR_PARM_DMA_cb_parm_dma_adr_src(data)                             (0x7FFFFFFF&(data))
...
#define  LR_CR_LR_PARM_DMA_inst_adr                                              "0x00A5"
#define  LR_CR_LR_PARM_DMA_inst                                                  0x00A5
...
#define  LR_CR_LR_PARM_DMA_cr_parm_dma_busy_src(data)                            ((0x80000000&(data))>>31)
#define  LR_CR_LR_PARM_DMA_cr_parm_dma_adr_src(data)                             (0x7FFFFFFF&(data))
...
#define  LR_LR_DMA_inst_adr                                                      "0x00A6"
#define  LR_LR_DMA_inst                                                          0x00A6
...
#define  LR_LR_DMA_dma_busy_src(data)                                            ((0x80000000&(data))>>31)
#define  LR_LR_DMA_dma_adr_src(data)                                             (0x7FFFFFFF&(data))
...
#define  LR_LR_PIC_INFO_inst_adr                                                 "0x00A7"
#define  LR_LR_PIC_INFO_inst                                                     0x00A7
...
#define  LR_LR_PIC_INFO_luma_res_type_src(data)                                  ((0x00000300&(data))>>8)
#define  LR_LR_PIC_INFO_cb_res_type_src(data)                                    ((0x000000C0&(data))>>6)
#define  LR_LR_PIC_INFO_cr_res_type_src(data)                                    ((0x00000030&(data))>>4)
#define  LR_LR_PIC_INFO_lu_res_unit_size_src(data)                               ((0x0000000C&(data))>>2)
#define  LR_LR_PIC_INFO_ch_res_unit_size_src(data)                               (0x00000003&(data))
...
#define  LR_LR_HOR_UPSACLE_inst_adr                                              "0x00A8"
#define  LR_LR_HOR_UPSACLE_inst                                                  0x00A8
...
#define  LR_LR_HOR_UPSACLE_use_superres_src(data)                                ((0x00000008&(data))>>3)
#define  LR_LR_HOR_UPSACLE_superres_denom_src(data)                              (0x00000007&(data))
...
#define  LR_SR_LU_PARM_inst_adr                                                  "0x00A9"
#define  LR_SR_LU_PARM_inst                                                      0x00A9
...
#define  LR_SR_LU_PARM_lu_step_x_src(data)                                       ((0x1FFFC000&(data))>>14)
#define  LR_SR_LU_PARM_lu_init_x_src(data)                                       (0x00003FFF&(data))
...
#define  LR_SR_CH_PARM_inst_adr                                                  "0x00AA"
#define  LR_SR_CH_PARM_inst                                                      0x00AA
...
#define  LR_SR_CH_PARM_ch_step_x_src(data)                                       ((0x1FFFC000&(data))>>14)
#define  LR_SR_CH_PARM_ch_init_x_src(data)                                       (0x00003FFF&(data))

#ifdef _LR_USE_STRUCT
