...
#define  VMA_DMACTLA_itblk_sel_shift                                             (31)
...
#define  VMA_DMACTLA_itblk_sel_mask                                              (0x80000000)
...
#define  VMA_DMACTLA_itblk_sel(data)                                             (0x80000000&((data)<<31))
...
#define  VMA_DMACTLA_get_itblk_sel(data)                                         ((0x80000000&(data))>>31)
...
#define  VMA_DMACTLA_itblk_sel_src(data)                                         ((0x80000000&(data))>>31)
#define  VMA_DMACTLA_Crc_sel_src(data)                                           ((0x40000000&(data))>>30)
...
#define  VMA_CRCA_inst_adr                                                       "0x009F"
#define  VMA_CRCA_inst                                                           0x009F
...
#define  VMA_BNKCTLA0_write_enable6_src(data)                                    ((0x20000000&(data))>>29)
#define  VMA_BNKCTLA0_bnk5_mstr_src(data)                                        ((0x1E000000&(data))>>25)
#define  VMA_BNKCTLA0_write_enable5_src(data)                                    ((0x01000000&(data))>>24)
#define  VMA_BNKCTLA0_bnk4_mstr_src(data)                                        ((0x00F00000&(data))>>20)
#define  VMA_BNKCTLA0_write_enable4_src(data)                                    ((0x00080000&(data))>>19)
#define  VMA_BNKCTLA0_bnk3_mstr_src(data)                                        ((0x00078000&(data))>>15)
#define  VMA_BNKCTLA0_write_enable3_src(data)                                    ((0x00004000&(data))>>14)
#define  VMA_BNKCTLA0_bnk2_mstr_src(data)                                        ((0x00003C00&(data))>>10)
#define  VMA_BNKCTLA0_write_enable2_src(data)                                    ((0x00000200&(data))>>9)
#define  VMA_BNKCTLA0_bnk1_mstr_src(data)                                        ((0x000001E0&(data))>>5)
#define  VMA_BNKCTLA0_write_enable1_src(data)                                    ((0x00000010&(data))>>4)
#define  VMA_BNKCTLA0_bnk0_mstr_src(data)                                        (0x0000000F&(data))
...
#define  VMA_BNKCTLA1_write_enable5_src(data)                                    ((0x20000000&(data))>>29)
#define  VMA_BNKCTLA1_vm_vfiller0_src(data)                                      ((0x1E000000&(data))>>25)
#define  VMA_BNKCTLA1_write_enable4_src(data)                                    ((0x01000000&(data))>>24)
#define  VMA_BNKCTLA1_vm_bnk_src(data)                                           ((0x00F00000&(data))>>20)
#define  VMA_BNKCTLA1_write_enable3_src(data)                                    ((0x00080000&(data))>>19)
#define  VMA_BNKCTLA1_cmprs_bnk_src(data)                                        ((0x00078000&(data))>>15)
#define  VMA_BNKCTLA1_write_enable2_src(data)                                    ((0x00004000&(data))>>14)
#define  VMA_BNKCTLA1_sao_bnk_src(data)                                          ((0x00003C00&(data))>>10)
#define  VMA_BNKCTLA1_write_enable1_src(data)                                    ((0x00000200&(data))>>9)
#define  VMA_BNKCTLA1_deblk_bnk_src(data)                                        ((0x000001E0&(data))>>5)
#define  VMA_BNKCTLA1_write_enable0_src(data)                                    ((0x00000010&(data))>>4)
#define  VMA_BNKCTLA1_pred_bnk_src(data)                                         (0x0000000F&(data))

#define  VMA_BNKCTLA2                                                           0x1800EE74
#define  VMA_BNKCTLA2_reg_addr                                                   "0xB800EE74"
#define  VMA_BNKCTLA2_reg                                                        0xB800EE74
#define  VMA_BNKCTLA2_inst_adr                                                   "0x009D"
#define  VMA_BNKCTLA2_inst                                                       0x009D
...
#define  VMA_BNKCTLA2_write_enable5_src(data)                                    ((0x20000000&(data))>>29)
#define  VMA_BNKCTLA2_bnk9_mstr_src(data)                                        ((0x1E000000&(data))>>25)
#define  VMA_BNKCTLA2_write_enable4_src(data)                                    ((0x01000000&(data))>>24)
#define  VMA_BNKCTLA2_bnk8_mstr_src(data)                                        ((0x00F00000&(data))>>20)
#define  VMA_BNKCTLA2_write_enable3_src(data)                                    ((0x00080000&(data))>>19)
#define  VMA_BNKCTLA2_vm_vfiller2_src(data)                                      ((0x00078000&(data))>>15)
#define  VMA_BNKCTLA2_write_enable2_src(data)                                    ((0x00004000&(data))>>14)
#define  VMA_BNKCTLA2_vm_vfiller1_src(data)                                      ((0x00003C00&(data))>>10)
#define  VMA_BNKCTLA2_write_enable1_src(data)                                    ((0x00000200&(data))>>9)
#define  VMA_BNKCTLA2_lr_bnk_src(data)                                           ((0x000001E0&(data))>>5)
#define  VMA_BNKCTLA2_write_enable0_src(data)                                    ((0x00000010&(data))>>4)
#define  VMA_BNKCTLA2_alf_bnk_src(data)                                          (0x0000000F&(data))

#define  VMA_BNKCTLA3                                                           0x1800EE78
#define  VMA_BNKCTLA3_reg_addr                                                   "0xB800EE78"
#define  VMA_BNKCTLA3_reg                                                        0xB800EE78
#define  VMA_BNKCTLA3_inst_adr                                                   "0x009E"
#define  VMA_BNKCTLA3_inst                                                       0x009E
...
#define  VMA_BNKCTLA3_write_enable7_src(data)                                    ((0x08000000&(data))>>27)
#define  VMA_BNKCTLA3_Tmp1_mstr_src(data)                                        ((0x04000000&(data))>>26)
#define  VMA_BNKCTLA3_write_enable6_src(data)                                    ((0x02000000&(data))>>25)
#define  VMA_BNKCTLA3_Tmp0_mstr_src(data)                                        ((0x01000000&(data))>>24)
#define  VMA_BNKCTLA3_write_enable5_src(data)                                    ((0x00800000&(data))>>23)
#define  VMA_BNKCTLA3_Tmp_vm_src(data)                                           ((0x00400000&(data))>>22)
#define  VMA_BNKCTLA3_write_enable4_src(data)                                    ((0x00200000&(data))>>21)
#define  VMA_BNKCTLA3_Tmp_cmprs_src(data)                                        ((0x00100000&(data))>>20)
#define  VMA_BNKCTLA3_write_enable3_src(data)                                    ((0x00080000&(data))>>19)
#define  VMA_BNKCTLA3_bnk11_mstr_src(data)                                       ((0x00078000&(data))>>15)
#define  VMA_BNKCTLA3_write_enable2_src(data)                                    ((0x00004000&(data))>>14)
#define  VMA_BNKCTLA3_bnk10_mstr_src(data)                                       ((0x00003C00&(data))>>10)
#define  VMA_BNKCTLA3_write_enable1_src(data)                                    ((0x00000200&(data))>>9)
#define  VMA_BNKCTLA3_bnk7_mstr_src(data)                                        ((0x000001E0&(data))>>5)
#define  VMA_BNKCTLA3_write_enable0_src(data)                                    ((0x00000010&(data))>>4)
#define  VMA_BNKCTLA3_bnk6_mstr_src(data)                                        (0x0000000F&(data))

#define  VMA_SPEED_CTRL                                                         0x1800EE80
#define  VMA_SPEED_CTRL_reg_addr                                                 "0xB800EE80"
#define  VMA_SPEED_CTRL_reg                                                      0xB800EE80
#define  VMA_SPEED_CTRL_inst_adr                                                 "0x00A0"
#define  VMA_SPEED_CTRL_inst                                                     0x00A0
#define  set_VMA_SPEED_CTRL_reg(data)                                            (*((volatile unsigned int*)VMA_SPEED_CTRL_reg)=data)
#define  get_VMA_SPEED_CTRL_reg                                                  (*((volatile unsigned int*)VMA_SPEED_CTRL_reg))
#define  VMA_SPEED_CTRL_Speed_en_shift                                           (11)
#define  VMA_SPEED_CTRL_speed_cnt_shift                                          (0)
#define  VMA_SPEED_CTRL_Speed_en_mask                                            (0x00000800)
#define  VMA_SPEED_CTRL_speed_cnt_mask                                           (0x000007FF)
#define  VMA_SPEED_CTRL_Speed_en(data)                                           (0x00000800&((data)<<11))
#define  VMA_SPEED_CTRL_speed_cnt(data)                                          (0x000007FF&(data))
#define  VMA_SPEED_CTRL_get_Speed_en(data)                                       ((0x00000800&(data))>>11)
#define  VMA_SPEED_CTRL_get_speed_cnt(data)                                      (0x000007FF&(data))
#define  VMA_SPEED_CTRL_Speed_en_src(data)                                       ((0x00000800&(data))>>11)
#define  VMA_SPEED_CTRL_speed_cnt_src(data)                                      (0x000007FF&(data))
