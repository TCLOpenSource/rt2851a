...
#define  DEBLK_HEVCDBPAR2_dmy_row_ctb_shift                                      (7)
#define  DEBLK_HEVCDBPAR2_dmy_clm_ctb_shift                                      (6)
#define  DEBLK_HEVCDBPAR2_mb_num_shift                                           (0)
#define  DEBLK_HEVCDBPAR2_dmy_row_ctb_mask                                       (0x00000080)
#define  DEBLK_HEVCDBPAR2_dmy_clm_ctb_mask                                       (0x00000040)
#define  DEBLK_HEVCDBPAR2_mb_num_mask                                            (0x0000003F)
#define  DEBLK_HEVCDBPAR2_dmy_row_ctb(data)                                      (0x00000080&((data)<<7))
#define  DEBLK_HEVCDBPAR2_dmy_clm_ctb(data)                                      (0x00000040&((data)<<6))
#define  DEBLK_HEVCDBPAR2_mb_num(data)                                           (0x0000003F&(data))
#define  DEBLK_HEVCDBPAR2_get_dmy_row_ctb(data)                                  ((0x00000080&(data))>>7)
#define  DEBLK_HEVCDBPAR2_get_dmy_clm_ctb(data)                                  ((0x00000040&(data))>>6)
#define  DEBLK_HEVCDBPAR2_get_mb_num(data)                                       (0x0000003F&(data))

#define  DEBLK_EXTRA_CTRL                                                       0x1800EAF8
#define  DEBLK_EXTRA_CTRL_reg_addr                                               "0xB800EAF8"
#define  DEBLK_EXTRA_CTRL_reg                                                    0xB800EAF8
#define  DEBLK_EXTRA_CTRL_inst_addr                                              "0x003E"
#define  set_DEBLK_EXTRA_CTRL_reg(data)                                          (*((volatile unsigned int*)DEBLK_EXTRA_CTRL_reg)=data)
#define  get_DEBLK_EXTRA_CTRL_reg                                                (*((volatile unsigned int*)DEBLK_EXTRA_CTRL_reg))
#define  DEBLK_EXTRA_CTRL_bits_shift                                             (5)
#define  DEBLK_EXTRA_CTRL_dmy_row_delay_shift                                    (0)
#define  DEBLK_EXTRA_CTRL_bits_mask                                              (0xFFFFFFE0)
#define  DEBLK_EXTRA_CTRL_dmy_row_delay_mask                                     (0x0000001F)
#define  DEBLK_EXTRA_CTRL_bits(data)                                             (0xFFFFFFE0&((data)<<5))
#define  DEBLK_EXTRA_CTRL_dmy_row_delay(data)                                    (0x0000001F&(data))
#define  DEBLK_EXTRA_CTRL_get_bits(data)                                         ((0xFFFFFFE0&(data))>>5)
#define  DEBLK_EXTRA_CTRL_get_dmy_row_delay(data)                                (0x0000001F&(data))
...
typedef union
{
    ...
    struct{
        RBus_UInt32  bits:27;
        RBus_UInt32  dmy_row_delay:5;
    };
}deblk_extra_ctrl_RBUS;
