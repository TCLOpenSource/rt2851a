/**
* @file Mac7p-DesignSpec-I-Domain_SyncProcessor
...
#define  SYNC_PROCESSOR_updw_debug_function_debug_force_start_shift              (6)
#define  SYNC_PROCESSOR_updw_debug_function_debug_period_shift                   (4)
#define  SYNC_PROCESSOR_updw_debug_function_debug_updw_sel_shift                 (3)
#define  SYNC_PROCESSOR_updw_debug_function_debug_updw_ch_sel_shift              (1)
#define  SYNC_PROCESSOR_updw_debug_function_debug_force_en_shift                 (0)
#define  SYNC_PROCESSOR_updw_debug_function_debug_force_start_mask               (0x00000040)
#define  SYNC_PROCESSOR_updw_debug_function_debug_period_mask                    (0x00000030)
#define  SYNC_PROCESSOR_updw_debug_function_debug_updw_sel_mask                  (0x00000008)
#define  SYNC_PROCESSOR_updw_debug_function_debug_updw_ch_sel_mask               (0x00000006)
#define  SYNC_PROCESSOR_updw_debug_function_debug_force_en_mask                  (0x00000001)
#define  SYNC_PROCESSOR_updw_debug_function_debug_force_start(data)              (0x00000040&((data)<<6))
#define  SYNC_PROCESSOR_updw_debug_function_debug_period(data)                   (0x00000030&((data)<<4))
#define  SYNC_PROCESSOR_updw_debug_function_debug_updw_sel(data)                 (0x00000008&((data)<<3))
#define  SYNC_PROCESSOR_updw_debug_function_debug_updw_ch_sel(data)              (0x00000006&((data)<<1))
#define  SYNC_PROCESSOR_updw_debug_function_debug_force_en(data)                 (0x00000001&(data))
#define  SYNC_PROCESSOR_updw_debug_function_get_debug_force_start(data)          ((0x00000040&(data))>>6)
#define  SYNC_PROCESSOR_updw_debug_function_get_debug_period(data)               ((0x00000030&(data))>>4)
#define  SYNC_PROCESSOR_updw_debug_function_get_debug_updw_sel(data)             ((0x00000008&(data))>>3)
#define  SYNC_PROCESSOR_updw_debug_function_get_debug_updw_ch_sel(data)          ((0x00000006&(data))>>1)
#define  SYNC_PROCESSOR_updw_debug_function_get_debug_force_en(data)             (0x00000001&(data))
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:25;
        RBus_UInt32  debug_force_start:1;
        RBus_UInt32  debug_period:2;
        RBus_UInt32  debug_updw_sel:1;
        RBus_UInt32  debug_updw_ch_sel:2;
        RBus_UInt32  debug_force_en:1;
    };
