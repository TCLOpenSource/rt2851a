...
#define  DMA_VGIP_DMA_VGIP_ACT_VSTA_Length_dma_iv_act_sta_mask                   (0x3FFF0000)
#define  DMA_VGIP_DMA_VGIP_ACT_VSTA_Length_dma_iv_act_len_mask                   (0x00003FFF)
#define  DMA_VGIP_DMA_VGIP_ACT_VSTA_Length_dma_iv_act_sta(data)                  (0x3FFF0000&((data)<<16))
#define  DMA_VGIP_DMA_VGIP_ACT_VSTA_Length_dma_iv_act_len(data)                  (0x00003FFF&(data))
#define  DMA_VGIP_DMA_VGIP_ACT_VSTA_Length_get_dma_iv_act_sta(data)              ((0x3FFF0000&(data))>>16)
#define  DMA_VGIP_DMA_VGIP_ACT_VSTA_Length_get_dma_iv_act_len(data)              (0x00003FFF&(data))
...
#define  DMA_VGIP_DMA_VGIP_DELAY_dma_ivs_dly_mask                                (0x00003FFF)
...
#define  DMA_VGIP_DMA_VGIP_DELAY_dma_ivs_dly(data)                               (0x00003FFF&(data))
...
#define  DMA_VGIP_DMA_VGIP_DELAY_get_dma_ivs_dly(data)                           (0x00003FFF&(data))
...
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_dma_captst_field_sel_shift                   (30)
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_dma_vcaptst_num_shift                        (16)
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_dma_captst_mode_shift                        (14)
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_dma_hcaptst_num_shift                        (0)
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_dma_captst_en_mask                           (0x80000000)
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_dma_captst_field_sel_mask                    (0x40000000)
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_dma_vcaptst_num_mask                         (0x3FFF0000)
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_dma_captst_mode_mask                         (0x0000C000)
...
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_dma_captst_field_sel(data)                   (0x40000000&((data)<<30))
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_dma_vcaptst_num(data)                        (0x3FFF0000&((data)<<16))
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_dma_captst_mode(data)                        (0x0000C000&((data)<<14))
...
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_get_dma_captst_field_sel(data)               ((0x40000000&(data))>>30)
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_get_dma_vcaptst_num(data)                    ((0x3FFF0000&(data))>>16)
#define  DMA_VGIP_DMA_VGIP_PTN_H_VI_get_dma_captst_mode(data)                    ((0x0000C000&(data))>>14)
...
#define  DMA_VGIP_DMA_VGIP_LC_dma_line_cnt_shift                                 (16)
#define  DMA_VGIP_DMA_VGIP_LC_dma_vlc_ie_shift                                   (14)
...
#define  DMA_VGIP_DMA_VGIP_LC_dma_line_cnt_mask                                  (0x3FFF0000)
#define  DMA_VGIP_DMA_VGIP_LC_dma_vlc_ie_mask                                    (0x00004000)
#define  DMA_VGIP_DMA_VGIP_LC_dma_vln_mask                                       (0x00003FFF)
...
#define  DMA_VGIP_DMA_VGIP_LC_dma_line_cnt(data)                                 (0x3FFF0000&((data)<<16))
#define  DMA_VGIP_DMA_VGIP_LC_dma_vlc_ie(data)                                   (0x00004000&((data)<<14))
#define  DMA_VGIP_DMA_VGIP_LC_dma_vln(data)                                      (0x00003FFF&(data))
...
#define  DMA_VGIP_DMA_VGIP_LC_get_dma_line_cnt(data)                             ((0x3FFF0000&(data))>>16)
#define  DMA_VGIP_DMA_VGIP_LC_get_dma_vlc_ie(data)                               ((0x00004000&(data))>>14)
#define  DMA_VGIP_DMA_VGIP_LC_get_dma_vln(data)                                  (0x00003FFF&(data))
...
#define  DMA_VGIP_DMA_VGIP_CRC_CTRL_dma_den_crc_sel_shift                        (7)
...
#define  DMA_VGIP_DMA_VGIP_CRC_CTRL_dma_den_crc_sel_mask                         (0x00000080)
...
#define  DMA_VGIP_DMA_VGIP_CRC_CTRL_dma_den_crc_sel(data)                        (0x00000080&((data)<<7))
...
#define  DMA_VGIP_DMA_VGIP_CRC_CTRL_get_dma_den_crc_sel(data)                    ((0x00000080&(data))>>7)
...
#define  DMA_VGIP_DMA_VGIP_CTS_FIFO_CTL_dma_toggle_ctsfifo_vgip_shift            (4)
#define  DMA_VGIP_DMA_VGIP_CTS_FIFO_CTL_dma_ctsfifo_gate_vgip_shift              (3)
...
#define  DMA_VGIP_DMA_VGIP_CTS_FIFO_CTL_dma_toggle_ctsfifo_vgip_mask             (0x00000010)
#define  DMA_VGIP_DMA_VGIP_CTS_FIFO_CTL_dma_ctsfifo_gate_vgip_mask               (0x00000008)
...
#define  DMA_VGIP_DMA_VGIP_CTS_FIFO_CTL_dma_toggle_ctsfifo_vgip(data)            (0x00000010&((data)<<4))
#define  DMA_VGIP_DMA_VGIP_CTS_FIFO_CTL_dma_ctsfifo_gate_vgip(data)              (0x00000008&((data)<<3))
...
#define  DMA_VGIP_DMA_VGIP_CTS_FIFO_CTL_get_dma_toggle_ctsfifo_vgip(data)        ((0x00000010&(data))>>4)
#define  DMA_VGIP_DMA_VGIP_CTS_FIFO_CTL_get_dma_ctsfifo_gate_vgip(data)          ((0x00000008&(data))>>3)
...
#define  DMA_VGIP_DMA_VGIP_DOUBLE_BUFFER_CTRL_inst_addr                          "0x0023"
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:2;
        RBus_UInt32  dma_iv_act_sta:14;
        RBus_UInt32  res2:2;
        RBus_UInt32  dma_iv_act_len:14;
    };
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  dma_vcaptst_num:14;
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  dma_line_cnt:14;
        RBus_UInt32  res1:1;
        RBus_UInt32  dma_vlc_ie:1;
        RBus_UInt32  dma_vln:14;
    };
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  res2:3;
        RBus_UInt32  dma_toggle_ctsfifo_vgip:1;
        RBus_UInt32  dma_ctsfifo_gate_vgip:1;
