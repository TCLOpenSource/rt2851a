...
#define  VGIP_PTG_PTG_CTRL_shift_size_mode_shift                                 (21)
...
#define  VGIP_PTG_PTG_CTRL_color_bar_mode_en_mask                                (0x00C00000)
#define  VGIP_PTG_PTG_CTRL_shift_size_mode_mask                                  (0x00200000)
...
#define  VGIP_PTG_PTG_CTRL_color_bar_mode_en(data)                               (0x00C00000&((data)<<22))
#define  VGIP_PTG_PTG_CTRL_shift_size_mode(data)                                 (0x00200000&((data)<<21))
...
#define  VGIP_PTG_PTG_CTRL_get_color_bar_mode_en(data)                           ((0x00C00000&(data))>>22)
#define  VGIP_PTG_PTG_CTRL_get_shift_size_mode(data)                             ((0x00200000&(data))>>21)
...
#define  VGIP_PTG_PTG_CHN1_ACT_HSTA_Width                                       0x180222E8
#define  VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_reg_addr                               "0xB80222E8"
#define  VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_reg                                    0xB80222E8
#define  VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_inst_addr                              "0x0009"
#define  set_VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_reg(data)                          (*((volatile unsigned int*)VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_reg)=data)
#define  get_VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_reg                                (*((volatile unsigned int*)VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_reg))
#define  VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_ptg_ch1_ih_act_sta_shift               (16)
#define  VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_ptg_ch1_ih_act_wid_shift               (0)
#define  VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_ptg_ch1_ih_act_sta_mask                (0x3FFF0000)
#define  VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_ptg_ch1_ih_act_wid_mask                (0x00003FFF)
#define  VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_ptg_ch1_ih_act_sta(data)               (0x3FFF0000&((data)<<16))
#define  VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_ptg_ch1_ih_act_wid(data)               (0x00003FFF&(data))
#define  VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_get_ptg_ch1_ih_act_sta(data)           ((0x3FFF0000&(data))>>16)
#define  VGIP_PTG_PTG_CHN1_ACT_HSTA_Width_get_ptg_ch1_ih_act_wid(data)           (0x00003FFF&(data))

#define  VGIP_PTG_PTG_CHN1_ACT_VSTA_Width                                       0x180222EC
#define  VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_reg_addr                               "0xB80222EC"
#define  VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_reg                                    0xB80222EC
#define  VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_inst_addr                              "0x000A"
#define  set_VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_reg(data)                          (*((volatile unsigned int*)VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_reg)=data)
#define  get_VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_reg                                (*((volatile unsigned int*)VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_reg))
#define  VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_ptg_ch1_iv_act_sta_shift               (16)
#define  VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_ptg_ch1_iv_act_len_shift               (0)
#define  VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_ptg_ch1_iv_act_sta_mask                (0x3FFF0000)
#define  VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_ptg_ch1_iv_act_len_mask                (0x00003FFF)
#define  VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_ptg_ch1_iv_act_sta(data)               (0x3FFF0000&((data)<<16))
#define  VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_ptg_ch1_iv_act_len(data)               (0x00003FFF&(data))
#define  VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_get_ptg_ch1_iv_act_sta(data)           ((0x3FFF0000&(data))>>16)
#define  VGIP_PTG_PTG_CHN1_ACT_VSTA_Width_get_ptg_ch1_iv_act_len(data)           (0x00003FFF&(data))
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:8;
        RBus_UInt32  color_bar_mode_en:2;
        RBus_UInt32  shift_size_mode:1;
        RBus_UInt32  res2:13;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:2;
        RBus_UInt32  ptg_ch1_ih_act_sta:14;
        RBus_UInt32  res2:2;
        RBus_UInt32  ptg_ch1_ih_act_wid:14;
    };
}vgip_ptg_ptg_chn1_act_hsta_width_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:2;
        RBus_UInt32  ptg_ch1_iv_act_sta:14;
        RBus_UInt32  res2:2;
        RBus_UInt32  ptg_ch1_iv_act_len:14;
    };
}vgip_ptg_ptg_chn1_act_vsta_width_RBUS;
