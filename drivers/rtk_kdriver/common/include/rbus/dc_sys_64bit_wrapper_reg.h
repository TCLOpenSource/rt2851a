/**
* @file Mac7p-DesignSpec-DC_SYS_64bit_wrapper_register
...
#define  DC_SYS_64BIT_WRAPPER_DC_SFRX_TEST_fail_bit_status_shift                 (31)
#define  DC_SYS_64BIT_WRAPPER_DC_SFRX_TEST_debug_bit_sel_shift                   (20)
...
#define  DC_SYS_64BIT_WRAPPER_DC_SFRX_TEST_fail_bit_status_mask                  (0x80000000)
#define  DC_SYS_64BIT_WRAPPER_DC_SFRX_TEST_debug_bit_sel_mask                    (0x0FF00000)
...
#define  DC_SYS_64BIT_WRAPPER_DC_SFRX_TEST_fail_bit_status(data)                 (0x80000000&((data)<<31))
#define  DC_SYS_64BIT_WRAPPER_DC_SFRX_TEST_debug_bit_sel(data)                   (0x0FF00000&((data)<<20))
...
#define  DC_SYS_64BIT_WRAPPER_DC_SFRX_TEST_get_fail_bit_status(data)             ((0x80000000&(data))>>31)
#define  DC_SYS_64BIT_WRAPPER_DC_SFRX_TEST_get_debug_bit_sel(data)               ((0x0FF00000&(data))>>20)
