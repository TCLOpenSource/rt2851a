/**
* @file Mac7p-DesignSpec-ISO_MISC_GPIO
...
#define  GPIO_GPDATI_1_gpdati_mask                                               (0x00FFFFFE)
#define  GPIO_GPDATI_1_gpdati(data)                                              (0x00FFFFFE&((data)<<1))
#define  GPIO_GPDATI_1_get_gpdati(data)                                          ((0x00FFFFFE&(data))>>1)
