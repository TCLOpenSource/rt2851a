/**
* @file Mac7p_DesignSpec-AV1_film_grain
...
#define  FILM_GRAIN_FILM_GRAIN_Dummy                                            0x18005510
#define  FILM_GRAIN_FILM_GRAIN_Dummy_reg_addr                                    "0xB8005510"
#define  FILM_GRAIN_FILM_GRAIN_Dummy_reg                                         0xB8005510
#define  FILM_GRAIN_FILM_GRAIN_Dummy_inst_addr                                   "0x0041"
#define  set_FILM_GRAIN_FILM_GRAIN_Dummy_reg(data)                               (*((volatile unsigned int*)FILM_GRAIN_FILM_GRAIN_Dummy_reg)=data)
#define  get_FILM_GRAIN_FILM_GRAIN_Dummy_reg                                     (*((volatile unsigned int*)FILM_GRAIN_FILM_GRAIN_Dummy_reg))
#define  FILM_GRAIN_FILM_GRAIN_Dummy_dummy_31_0_shift                            (0)
#define  FILM_GRAIN_FILM_GRAIN_Dummy_dummy_31_0_mask                             (0xFFFFFFFF)
#define  FILM_GRAIN_FILM_GRAIN_Dummy_dummy_31_0(data)                            (0xFFFFFFFF&(data))
#define  FILM_GRAIN_FILM_GRAIN_Dummy_get_dummy_31_0(data)                        (0xFFFFFFFF&(data))
...
typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  dummy18005510_31_0:32;
    };
}film_grain_film_grain_dummy_RBUS;
