...
typedef struct {
	...
	//unsigned char SNR_maxmin_range;  /*Merlin2*/
...
typedef struct {/*Veritcal_NR*/
	...
	//unsigned char SNR_Vertical_Th2_start; //Merlin2
	//unsigned char SNR_Veritcal_avlpf2D_En; //Merlin2
	//unsigned char SNR_Veritcal_avlpf2D_Tolirant_En; //Merlin2
	//unsigned char SNR_Veritcal_avlpf2D_Tolirant_Mode; //Merlin2
	//unsigned char SNR_Veritcal_avlpf2D_Tolirant_Offset; //Merlin2
...
/*	unsigned char SNR_mosquito_detect_en;		*/ /*Mosquito_NR_MNR Global Control*/
	...
	//unsigned char MNR_xrange_ext; /*Merlin2*/
...
typedef struct {
	...
	DRV_VipNewDDcti_uvhalfmid_ctl0 VipNewDDcti_uvhalfmid_ctl0;
	DRV_VipNewDDcti_uvhalfmid_ctl1 VipNewDDcti_uvhalfmid_ctl1;
	DRV_VipNewDDcti_uvhalfmid_ctl2 VipNewDDcti_uvhalfmid_ctl2;
...
typedef struct {
	...
	short Reserved11;/*magellan2*/
	short Reserved12;/*magellan2*/
	short sr_detail_v_tex_en;/*magellan2*/
	short Reserved14;/*magellan2*/
	short sr_detail_tex_en;/*magellan2*/
	short Reserved16;/*magellan2*/
	short Reserved17;/*magellan2*/
	short Reserved18;/*magellan2*/
	short Reserved19;/*magellan2*/
...
#endif //mac6p removed VIP_Edge_SM
...
typedef struct {
	...
	//VIP_Edge_Pos_Curve Edge_Pos_Curve;/*row008 magellan2*/ //mac6p removed
	//VIP_Edge_Neg_Curve Edge_Neg_Curve;/*row009 magellan2*/ //mac6p removed
	...
	//VIP_Tex_Pos_Curve Tex_Pos_Curve;/*row017 magellan2*/ //mac6p removed
	//VIP_Tex_Neg_Curve Tex_Neg_Curve;/*row018 magellan2*/ //mac6p removed
	VIP_Texture_EMF_Table Texture_EMF_Table;/*row019*/
	VIP_Vertical_Shp_t Vertical;/*row020*/
	//VIP_V_Pos_Curve V_Pos_Curve;/*row021 magellan2*/ //mac6p removed
	//VIP_V_Neg_Curve V_Neg_Curve;/*row022 magellan2*/ //mac6p removed
	...
	//VIP_Y_Remap Y_Remap;/*row028*/ //mac6p removed
	VIP_Slope_gain_mask Slope_gain_mask;/*row029*/
	//VIP_After_Filter After_Filter;/*row030 magellan2*/ //mac6p removed
	...
	//VIP_Sub_Gain_Modify Sub_Gain_Modify;/*row040*/ //mac6p removed
	VIP_Vertical_edg_Shp_t Vertical_edg;/*row041 Merlin*/
	//VIP_Edge_SM Edge_SM;/*row042 Merlin*/ //mac6p removed
...
typedef struct {
        ...
        DRV_D_DLTI_Table D_DLTI_Table[VIP_PQ_EXTEND_SHARP_NUM];
        ...
        DRV_Local_Contrast_Table Local_Contrast_Table[VIP_PQ_EXTEND_DCC_NUM];
