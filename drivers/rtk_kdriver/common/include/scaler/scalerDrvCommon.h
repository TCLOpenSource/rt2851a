...
#define DEFAULT_ENABLE_DOUBLE_DVS 		TRUE
...
#define M_DOMAIN_WIDTH_CARVEOUT  M_DOMAIN_WIDTH_2K//kernel CARVEOUT size 
#define M_DOMAIN_LEN_CARVEOUT   M_DOMAIN_LEN_2K//kernel CARVEOUT size 
...
#define MDOMAIN_MAIN_BUFFER_SIZE_30BITS (M_DOMAIN_WIDTH_MAX_SIZE * M_DOMAIN_LEN_MAX_SIZE * 30 / 8)
#else
...
//	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS (drvif_memory_get_data_align((_DISP_WID * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * _DISP_LEN)//Update M-domain 4k2k 12bits for PQDC align @Crixus 20170620
#ifdef CONFIG_RTK_KDRV_DV_IDK_DUMP
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE)//Update M-domain 2k1k 12bits for PQDC align
#else
	...
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS_4K (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE)//Update M-domain 2k1k 12bits for PQDC align
#endif

	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS_HDMI (drvif_memory_get_data_align((M_DOMAIN_WIDTH_CARVEOUT * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_CARVEOUT)//Update M-domain 2k1k 12bits for PQDC align
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS_HDMI_4K (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE)//Update M-domain 2k1k 12bits for PQDC align
#else
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS_HDMI (drvif_memory_get_data_align((M_DOMAIN_WIDTH_CARVEOUT * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_CARVEOUT)//Update M-domain 2k1k 12bits for PQDC align
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS_HDMI_4K (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE)//Update M-domain 2k1k 12bits for PQDC align
...
#else
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS ((M_DOMAIN_WIDTH_CARVEOUT * 12 + 256) / 128 * M_DOMAIN_LEN_CARVEOUT * 16)
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS_4K ((M_DOMAIN_WIDTH_MAX_SIZE * 12 + 256) / 128 * M_DOMAIN_LEN_MAX_SIZE * 16)
#endif
#endif

#define MDOMAIN_MAIN_BUFFER_SIZE_24BITS (M_DOMAIN_WIDTH_CARVEOUT * M_DOMAIN_LEN_CARVEOUT * 24 / 8) //M-domain RGB444 mode
#ifdef CONFIG_BW_96B_ALIGNED
...
#ifdef CONFIG_RTK_KDRV_DV_IDK_DUMP
#define MDOMAIN_MAIN_BUFFER_SIZE_20BITS (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 20 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE) //M-domain RGB444 mode 20bits
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE)//livezoomcase
#else
...
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_4K (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE)//livezoomcase
#endif

#define MDOMAIN_MAIN_BUFFER_SIZE_20BITS_HDMI (drvif_memory_get_data_align((M_DOMAIN_WIDTH_CARVEOUT * 20 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_CARVEOUT) //M-domain RGB444 mode 20bits
...
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_HDMI_4K (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE)//livezoomcase
#else
#define MDOMAIN_MAIN_BUFFER_SIZE_20BITS (((M_DOMAIN_WIDTH_CARVEOUT * 20 + 256) / 8) * M_DOMAIN_LEN_CARVEOUT) //M-domain RGB444 mode 20bits
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS (((M_DOMAIN_WIDTH_CARVEOUT * 16 + 256) / 8) * M_DOMAIN_LEN_CARVEOUT)//livezoomcase
#define MDOMAIN_MAIN_BUFFER_SIZE_20BITS_HDMI (drvif_memory_get_data_align((M_DOMAIN_WIDTH_CARVEOUT * 20 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_CARVEOUT) //M-domain RGB444 mode 20bits
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_HDMI (drvif_memory_get_data_align((M_DOMAIN_WIDTH_CARVEOUT * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_CARVEOUT)//livezoomcase
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_4K (((M_DOMAIN_WIDTH_MAX_SIZE * 16 + 256) / 8) * M_DOMAIN_LEN_MAX_SIZE)//livezoomcase
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_HDMI_4K (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE)//livezoomcase
#endif
#define MDOMAIN_MAIN_BUFFER_SIZE_10BITS ((M_DOMAIN_WIDTH_MAX_SIZE + (32 - (M_DOMAIN_WIDTH_MAX_SIZE % 32))) *  M_DOMAIN_LEN_CARVEOUT * 10 / 8 + CONFIG_MDOMAIN_BURST_SIZE)//all data fs flow
#ifdef CONFIG_RTK_KDRV_DV_IDK_DUMP
...
#ifdef CONFIG_BW_96B_ALIGNED
#define MDOMAIN_MAIN_BUFFER_SIZE_MULT2K_12BITS (drvif_memory_get_data_align((M_DOMAIN_WIDTH_2K * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_2K)
#define MDOMAIN_MAIN_BUFFER_SIZE_MULT4K_12BITS (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE)
#else
#define MDOMAIN_MAIN_BUFFER_SIZE_MULT2K_12BITS (M_DOMAIN_WIDTH_2K * M_DOMAIN_LEN_2K * 12 / 8)
#define MDOMAIN_MAIN_BUFFER_SIZE_MULT4K_12BITS (M_DOMAIN_WIDTH_MAX_SIZE * M_DOMAIN_LEN_MAX_SIZE * 12 / 8)
#endif

/* apvr and livezoom sub size*/
#define MDOMAIN_SUB_BUFFER_SIZE (drvif_memory_get_data_align((M_DOMAIN_WIDTH_2K * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_2K) //2k1k 12 bits
...
#define VIP_DI_1_BUFFER_SIZE_2K_PLATFORM (1024 * 1024 * 9) // DI 1 : 9M for 2K Model
...
#define CONFIG_VDEC_HDR_SDR_SEAMLESS
