...
#define DEMUX_IOC_DELIVERY_INIT                  (_IOWR(DEMUX_IOC_MAGIC, 79, int))
#define DEMUX_IOC_DELIVERY_UNINIT                (_IOR (DEMUX_IOC_MAGIC, 80, int))
#define DEMUX_IOC_DELIVERY_OPEN                  (_IOWR(DEMUX_IOC_MAGIC, 81, DEMUX_DELIVERY_CHANNEL_T))
#define DEMUX_IOC_DELIVERY_CLOSE                 (_IOR (DEMUX_IOC_MAGIC, 82, DEMUX_DELIVERY_CHANNEL_T))
#define DEMUX_IOC_DELIVERY_SET_TP_INPUT_CONFIG   (_IOR (DEMUX_IOC_MAGIC, 83, DEMUX_TP_SOURCE_CONFIG_T))
#define DEMUX_IOC_DELIVERY_REQUEST_BBFRAME       (_IOR (DEMUX_IOC_MAGIC, 84, DEMUX_DELIVERY_CHANNEL_T))
#define DEMUX_IOC_DELIVERY_CANCEL_BBFRAME        (_IOR (DEMUX_IOC_MAGIC, 85, DEMUX_DELIVERY_CHANNEL_T))
#define DEMUX_IOC_DELIVERY_GET_BBFRAME_BUFFER    (_IOR (DEMUX_IOC_MAGIC, 86, DEMUX_DELIVERY_GET_BBF_BUFFER_T))
#define DEMUX_IOC_DELIVERY_RETURN_BBFRAME_BUFFER (_IOR (DEMUX_IOC_MAGIC, 87, DEMUX_DELIVERY_GET_BBF_BUFFER_T))
#define DEMUX_IOC_DELIVERY_GET_BBFRAME_BUFF_INFO (_IOR (DEMUX_IOC_MAGIC, 88, DEMUX_DELIVERY_BBF_BUFFER_INFO_T))
#define DEMUX_IOC_VTP_VDEC_CONNECT               (_IOR (DEMUX_IOC_MAGIC, 89, DEMUX_VTP_VDEC_MAP_T))
#define DEMUX_IOC_VTP_VDEC_DISCONNECT            (_IOR (DEMUX_IOC_MAGIC, 90, DEMUX_VTP_VDEC_MAP_T))

#define DEMUX_IOC_DELIVERY_GET_CURRENT_TIME_INFO (_IOR (DEMUX_IOC_MAGIC, 91, DEMUX_DELIVERY_TIME_INFO_T))
#define DEMUX_IOC_DELIVERY_SET_CURRENT_TIME_INFO (_IOR (DEMUX_IOC_MAGIC, 92, DEMUX_DELIVERY_TIME_INFO_T))
#define DEMUX_IOC_DELIVERY_SET_SYSTEM_TIME_INFO  (_IOR (DEMUX_IOC_MAGIC, 93, DEMUX_DELIVERY_SYSTEM_TIME_INFO_T))
#define DEMUX_IOC_DELIVERY_SET_CLOCK_RECOVERY    (_IOR (DEMUX_IOC_MAGIC, 94, DEMUX_DELIVERY_CLOCK_RECOVERY_T))

#define DEMUX_IOC_DELIVERY_SET_MODE              (_IOR  (DEMUX_IOC_MAGIC, 95, DEMUX_DELIVERY_SET_MODE_T))
#define DEMUX_IOC_DELIVERY_REQUEST_DATA          (_IOR  (DEMUX_IOC_MAGIC, 96, DEMUX_DELIVERY_CHANNEL_T))
#define DEMUX_IOC_DELIVERY_CANCEL_DATA           (_IOR  (DEMUX_IOC_MAGIC, 97, DEMUX_DELIVERY_CHANNEL_T))
#define DEMUX_IOC_DELIVERY_GET_DATA              (_IOWR (DEMUX_IOC_MAGIC, 98, DEMUX_DELIVERY_READ_DATA_T))
#define DEMUX_IOC_DDR_PROTEC                     (_IOWR (DEMUX_IOC_MAGIC, 99, DEMUX_DDR_PROTECT))
#define DEMUX_IOC_GET_TP_BUF_STATUS             (_IOWR(DEMUX_IOC_MAGIC, 100, DEMUX_TP_BUF_STATUS_T*))
#define DEMUX_IOC_GET_ES_BUF_STATUS             (_IOWR(DEMUX_IOC_MAGIC, 101, DEMUX_ES_BUF_STATUS_T*))
#define DEMUX_IOC_GET_PCR_ADAPTION_FIELD		(_IOW (DEMUX_IOC_MAGIC, 102, DEMUX_PCR_ADAPTION_FIELD_T))
#define DEMUX_IOC_GET_PES_HEADER            (_IOW (DEMUX_IOC_MAGIC, 103, DEMUX_PES_HEADER_INFO_T))

#define DEMUX_IOC_MAXNR           104
