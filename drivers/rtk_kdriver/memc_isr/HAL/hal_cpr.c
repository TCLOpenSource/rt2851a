...
VOID HAL_CPR_Set444Enable(BOOL bEnable)//modify from merlin4, using RTK pqc 
{
	...
	if(bEnable){		
		...
		//rtd_maskl(0xb8099204,0xfffffffc,0x00000001); //444(bit:0)
		//rtd_maskl(0xb8099284,0xfffffffc,0x00000001); //444(bit:0)
		//rtd_maskl(0xb8099804,0xfffffffc,0x00000001); //444(bit:0)
		//rtd_maskl(0xb8099884,0xfffffffc,0x00000001); //444(bit:0)
