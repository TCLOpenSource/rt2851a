...
VOID Debug_Msg_Print(_PQLPARAMETER* g_pParam, _PQLCONTEXT* pContext)
{
	...
	if(display_timing_ctrl1_reg.disp_en == 1 && ((Scaler_DispGetInputInfoByDisp(SLR_MAIN_DISPLAY, SLR_INPUT_STATE) == _MODE_STATE_ACTIVE) /*|| MEMC_error_status_print_flag*/)){ // fix_me_andtv_bring_up
