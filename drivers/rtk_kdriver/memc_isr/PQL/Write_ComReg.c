...
VOID Identification_Pattern_preProcess(const _PARAM_WRT_COM_REG *pParam, _OUTPUT_WRT_COM_REG *pOutput)
{
	...
	static UBYTE u5_blend_holdfrm_preProcess_a[90] = {0};
	static UBYTE nIdentifiedNum_preProcess_a[90] = {0};
	UBYTE u8_Index;
	UINT32 u32_RB_val;
	...
	//===debug show
	for(u8_Index =0;u8_Index<90;u8_Index++)
	{
...
VOID Identification_Pattern_wrtAction(const _PARAM_WRT_COM_REG *pParam, _OUTPUT_WRT_COM_REG *pOutput)
{
	...
	if(scalerVIP_Get_MEMCPatternFlag_Identification(1) == TRUE  )
	{
...
VOID Dh_OCCL_Ext_wrtAction(const _PARAM_WRT_COM_REG *pParam, _OUTPUT_WRT_COM_REG *pOutput)
{
	...
	// force level
	if( s_pParam->_param_me_sceneAnalysis.u1_occl_ext_force_lvl_enable == 1 )
		occl_ext_level_sel = _MIN_(s_pParam->_param_me_sceneAnalysis.u1_occl_ext_force_lvl, 5);
...
VOID MEMC_DisableMute(const _PARAM_WRT_COM_REG *pParam, _OUTPUT_WRT_COM_REG *pOutput)
{
	...
	UINT32 test_val = 0;
	UBYTE scaler_force_bg_status =0;
