...
void rtk_lsadc_interrupt_init(LSADC_PCBINFO pcb_info, unsigned int en)
{
    ...
    irq_set.pin_name[sizeof(irq_set.pin_name)-1] = '\0';
...
void rtk_lsadc_init_pcb_pin(void){
    ...
    for(i = 0; i < PCB_ENUM_MAX; i++){
        ...
        {
	    if( _gLsadcInfo_count < MAX_LSADC_PCBINFO_COUNT ){
		    ...
		    memset(_gLsadcInfo[_gLsadcInfo_count].pinName, 0, sizeof(_gLsadcInfo[_gLsadcInfo_count].pinName));
                    ...
                    _gLsadcInfo[_gLsadcInfo_count].pinName[sizeof(_gLsadcInfo[_gLsadcInfo_count].pinName)-1] = '\0';
                ...
                LSADC_ERROR("Out of Range _gLsadcInfo_count %d, Max %d \n", _gLsadcInfo_count, MAX_LSADC_PCBINFO_COUNT);
	    }
        }
    }
}
