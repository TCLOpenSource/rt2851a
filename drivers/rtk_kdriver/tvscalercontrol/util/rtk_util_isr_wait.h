...
#define RUTIL_ISR_WAIT_ADV_DECLARE(waitName, condName, pParam, condToCheck, executeIfCondTrue, executeIfCondFalse)  \
    ...
    bool RUTIL_ISR_WAIT_ISR_CondToCheck_##waitName##_##condName(void) {                                             \
        condToCheck;                                                                                                \
    }                                                                                                               \
    ...
    bool (*pRUTIL_ISR_WAIT_FuncCondToCheck_##waitName)(void)                                                        \
...
#define RUTIL_ISR_WAIT_ADV_EXPORT(waitName)                                                                         \
    ...
    extern bool (*pRUTIL_ISR_WAIT_FuncCondToCheck_##waitName)(void);                                                \
...
#define RUTIL_ISR_WAIT_ADV_EXPORT_COND(waitName, condName)                                                          \
    ...
    extern bool RUTIL_ISR_WAIT_ISR_CondToCheck_##waitName##_##condName(void);                                       \
