...
void drvif_color_od_Ymode(void)
{
	...
	od_ymode_ctrl_reg.od_ymode_en = OD_Y_RGB_mode;
...
bool drvif_color_od_pqc(UINT16 height, UINT16 width, UINT8 bit_sel, UINT8 dma_mode, UINT8 FrameLimitBit, int dataColor, int dataFormat)
{
	...
	*/
	...
	oddma_pq_decmp_sat_en_reg.saturation_en = OD_Y_RGB_mode;
	...
	IoReg_Write32(OD_DMA_ODDMA_WR_num_bl_wrap_addr_0_reg, od_addr + burst_length);
	...
	IoReg_Write32(OD_DMA_ODDMA_RD_num_bl_wrap_addr_0_reg, od_addr + burst_length);
