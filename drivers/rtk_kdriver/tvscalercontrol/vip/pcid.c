...
void drvif_color_pcid2_poltable(unsigned int * pPcid2PolTable, DRV_pcid2_channel_t color)
{
	switch(color)
	{
		case _PCID2_COLOR_R:
		{
			...
			pcid_pcid2_polarity_r_4_reg.regValue = IoReg_Read32(PCID_PCID2_POLARITY_R_4_reg);
		...
		case _PCID2_COLOR_G:
		{
			...
			pcid_pcid2_polarity_g_4_reg.regValue = IoReg_Read32(PCID_PCID2_POLARITY_G_4_reg);
		...
		case _PCID2_COLOR_B:
		{
			...
			pcid_pcid2_polarity_b_4_reg.regValue = IoReg_Read32(PCID_PCID2_POLARITY_B_4_reg);
...
void drvif_color_get_pcid2_poltable(unsigned int * pPcid2PolTable, DRV_pcid2_channel_t color)
{
	switch(color)
	{
		case _PCID2_COLOR_R:
		{
			...
			pPcid2PolTable[0] = pcid_pcid2_polarity_r_1_reg.r_po_line1;
			pPcid2PolTable[1] = pcid_pcid2_polarity_r_1_reg.r_po_line2;
			pPcid2PolTable[2] = pcid_pcid2_polarity_r_2_reg.r_po_line3;
			pPcid2PolTable[3] = pcid_pcid2_polarity_r_2_reg.r_po_line4;
			pPcid2PolTable[4] = pcid_pcid2_polarity_r_3_reg.r_po_line5;
			pPcid2PolTable[5] = pcid_pcid2_polarity_r_3_reg.r_po_line6;
			pPcid2PolTable[6] = pcid_pcid2_polarity_r_4_reg.r_po_line7;
			pPcid2PolTable[7] = pcid_pcid2_polarity_r_4_reg.r_po_line8;
			break;
		}
		case _PCID2_COLOR_G:
		{
			...
			pPcid2PolTable[0] = pcid_pcid2_polarity_g_1_reg.g_po_line1;
			pPcid2PolTable[1] = pcid_pcid2_polarity_g_1_reg.g_po_line2;
			pPcid2PolTable[2] = pcid_pcid2_polarity_g_2_reg.g_po_line3;
			pPcid2PolTable[3] = pcid_pcid2_polarity_g_2_reg.g_po_line4;
			pPcid2PolTable[4] = pcid_pcid2_polarity_g_3_reg.g_po_line5;
			pPcid2PolTable[5] = pcid_pcid2_polarity_g_3_reg.g_po_line6;
			pPcid2PolTable[6] = pcid_pcid2_polarity_g_4_reg.g_po_line7;
			pPcid2PolTable[7] = pcid_pcid2_polarity_g_4_reg.g_po_line8;
			break;
		}
		case _PCID2_COLOR_B:
		{
			...
			pPcid2PolTable[0] = pcid_pcid2_polarity_b_1_reg.b_po_line1;
			pPcid2PolTable[1] = pcid_pcid2_polarity_b_1_reg.b_po_line2;
			pPcid2PolTable[2] = pcid_pcid2_polarity_b_2_reg.b_po_line3;
			pPcid2PolTable[3] = pcid_pcid2_polarity_b_2_reg.b_po_line4;
			pPcid2PolTable[4] = pcid_pcid2_polarity_b_3_reg.b_po_line5;
			pPcid2PolTable[5] = pcid_pcid2_polarity_b_3_reg.b_po_line6;
			pPcid2PolTable[6] = pcid_pcid2_polarity_b_4_reg.b_po_line7;
			pPcid2PolTable[7] = pcid_pcid2_polarity_b_4_reg.b_po_line8;
			break;
		}
		default:
			break;
