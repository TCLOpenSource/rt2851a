...
//---------------------------With SPD info-----------------------------------------------
	...
	HDMI_SPECIFIC_DEVICE_SONY_X700_AND_PIONEER_AMP,    //sony x700 connect pioneer amp , HDCP mode == HDCP14
//---------------------------Without SPD info-----------------------------------------------
...
typedef struct
{
     ...
     unsigned char check_characteristic_flag;
     unsigned char action_process_flag;     //Action special process
