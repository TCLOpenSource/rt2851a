...
//	dds_pll_pllphase_ctrl_RBUS dds_pll_pllphase_ctrl_reg;
	...
	rtd_printk(KERN_NOTICE, TAG_NAME_ADC, "#####[%s(%d)]auto phase=%d, uc64phase_limited:%d\n",__func__, __LINE__, phase, uc64phase_limited);
#if 0
	...
	rtd_printk(KERN_NOTICE, TAG_NAME_ADC, "####[%s(%d)]fine-tune phase=%d, PhaseMax=%d\n",__func__,__LINE__, phase, PhaseMax);
...
{	//input: _SRC_YPBPR, _SRC_AV
	...
	if(input == _SRC_VGA){
		...
		adc_ctl_rgb12_reg.adc_ctl_rgb1_8 = 0;
		adc_ctl_rgb12_reg.adc_ctl_rgb1_7 = 0;
		adc_ctl_rgb12_reg.adc_ctl_rgb1_5_4 = 0x0;
...
{
	//a. 0xb802000C[5:3] = 0xB80380BC[26:24]
	return (IoReg_Read32(EFUSE_DATAO_47_reg) & _BIT26)>>24;
}
