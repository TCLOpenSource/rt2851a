...
static const spinor_info_t default_device = {0x0,       ERASE_4K | ERASE_32K | ERASE_64K,           0x1000,    1, 0x100000, NULL,      eMODE_READ_NORMAL,    eMODE_WRITE_NORMAL, EMPTY_VALUE, EMPTY_VALUE, EMPTY_VALUE};
