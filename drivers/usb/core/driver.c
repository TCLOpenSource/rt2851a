...
static int is_u3_super_device(struct usb_device *udev)
{
	...
	if(strcmp(speed,"super-speed")==0 && strcmp(driver_name,"xhci-hcd")==0 ){
		return 1;
	}
	return 0;
...
#ifdef CONFIG_RTK_KDRV_XHCI_HCD_PLATFORM
	/* Do not going to U3 mode if super speed device */
	if(is_u3_super_device(udev)){
