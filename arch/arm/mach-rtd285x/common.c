...
void __init rtk_reserve(void)
{
	...
	/* for ib boundary */
	if (carvedout_buf[layout_idx][CARVEDOUT_IB_BOUNDARY][1])
		memblock_reserve(carvedout_buf[layout_idx][CARVEDOUT_IB_BOUNDARY][0], carvedout_buf[layout_idx][CARVEDOUT_IB_BOUNDARY][1]);
