...
#endif
	{0x1ffff000, 0x00001000}, // CARVEDOUT_IB_BOUNDARY
...
{
    const char *str_RTD285X = "RTD285X";

    if (strncmp(str_RTD285X, str, strlen(str_RTD285X))==0)
    {
        platform=PLATFORM_RTD285X;
        pr_info("RTDd285X platform\n");
    }
    else
    {
