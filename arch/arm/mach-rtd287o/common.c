...
void __init rtk_reserve(void)
{
	...
	/* for ddr boundary */
	if (carvedout_buf[layout_idx][CARVEDOUT_DDR_BOUNDARY][1])
		ret |= add_ban_info(carvedout_buf[layout_idx][CARVEDOUT_DDR_BOUNDARY][0], carvedout_buf[layout_idx][CARVEDOUT_DDR_BOUNDARY][1], BAN_NOT_USED);;
