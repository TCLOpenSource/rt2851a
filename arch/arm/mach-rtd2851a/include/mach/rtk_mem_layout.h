...
#define MDOMAIN_START_ADDRESS_KERNEL   0x30400000  // + 0d00000 (+  13M)
#define DI_NR_START_ADDRESS_KERNEL     0x31100000  // + 0900000 (+   9M)
#define NN_START_ADDRESS_KERNEL        0x31a00000  // +       0 (+   0M)
#define VIP_START_ADDRESS_KERNEL       0x31a00000  // + 0200000 (+   2M)
#define OD_START_ADDRESS_KERNEL        0x31c00000  // +       0 (+   0M)
#else
#define VBM_START_ADDRESS_KERNEL       0x20000000  // + 8400000 (+ 132M)
#define MEMC_START_ADDRESS_KERNEL      0x28400000  // + 0000000 (+   0M)
#define MDOMAIN_START_ADDRESS_KERNEL   0x28400000  // + 0d00000 (+  13M)
#define DI_NR_START_ADDRESS_KERNEL     0x29100000  // + 0900000 (+   9M)
#define NN_START_ADDRESS_KERNEL        0x29a00000  // +       0 (+   0M)
#define VIP_START_ADDRESS_KERNEL       0x29a00000  // + 0200000 (+   2M)
#define OD_START_ADDRESS_KERNEL        0x29c00000  // +       0 (+   0M)
#endif
...
#define SCALER_MDOMAIN_SIZE (13*_MB_) // 37MB(M-Domain)
...
#define DDR_1G5_NN_START_ADDRESS_KERNEL        0x30600000  // +       0 (+   0M)
...
#define DDR_1G5_MDOMAIN_START_ADDRESS_KERNEL   0x27000000  // + 0d00000 (+  13M)
#define DDR_1G5_DI_NR_START_ADDRESS_KERNEL     0x27d00000  // + 0900000 (+   9M)
#define DDR_1G5_NN_START_ADDRESS_KERNEL        0x28600000  // +       0 (+   0M)
#define DDR_1G5_VIP_START_ADDRESS_KERNEL       0x28600000  // + 0200000 (+   2M)
#define DDR_1G5_OD_START_ADDRESS_KERNEL        0x28800000  // +       0 (+   0M)
#endif
...
#define DDR_1G5_SCALER_MDOMAIN_SIZE (13*_MB_) // 37MB(M-Domain)
...
#define DDR_1G5_SCALER_DI_NR_SIZE (9*_MB_) // 13MB
...
#define DDR_1GB_VBM_START_ADDRESS_KERNEL       0x20000000  // + 8400000 (+ 132M)
#define DDR_1GB_MEMC_START_ADDRESS_KERNEL      0x28400000  // + 0000000 (+   0M)
#define DDR_1GB_MDOMAIN_START_ADDRESS_KERNEL   0x28400000  // + 2500000 (+  37M)
#define DDR_1GB_DI_NR_START_ADDRESS_KERNEL     0x2a900000  // + 0d00000 (+  13M)
#define DDR_1GB_NN_START_ADDRESS_KERNEL        0x2b600000  // + 0100000 (+   1M)
#define DDR_1GB_VIP_START_ADDRESS_KERNEL       0x2b700000  // + 0200000 (+   2M)
#define DDR_1GB_OD_START_ADDRESS_KERNEL        0x2b900000  // + 0400000 (+   4M)

#define DDR_1GB_VDEC_BUFFER_START (DDR_1GB_VBM_START_ADDRESS_KERNEL)
#define DDR_1GB_VDEC_BUFFER_SIZE 132*_MB_    // 132 MB for single 4K
...
#define DDR_2K_MODEL_VIDEO_RINGBUFFER_SIZE			0x1000000
...
#define DDR_2K_MODEL_NN_START_ADDRESS_KERNEL        0x22c00000  // + 0000000 (+   0M)
