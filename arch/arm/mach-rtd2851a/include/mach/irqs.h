...
#define SPI_SB2_EMCU_SCPU		SPI_NO(32)

#define SPI_SW_INT			SPI_NO(3)
...
#define SPI_NF_KCPU			SPI_NO(53)
#define SPI_SD_CARD			SPI_NO(18)
...
#define SPI_MISC_GPIO			SPI_NO(33)
#define SPI_MISC_GPIO_SECURE	SPI_NO(59)
#define SPI_MISC			SPI_NO(19)  //GPIO/I2C/UART/SC
#define SPI_MISC_I2C_1_I2C_2		SPI_NO(56)
#define SPI_MISC_UART_1_UART2		SPI_NO(56)

#define SPI_NNIP				SPI_NO(32)
#define SPI_NNIP_SECURE			SPI_NO(32)
...
#define IRQ_CPU2CPU		SPI_SW_INT	// ACPU/VCPU/VCPU2 to SCPU
...
#define IRQ_GPU_DECOMP	SPI_GPU_DECOMP
