...
#define SPI_MISC_TIMER4			SPI_NO(19)
...
#define SPI_MD_SECURE			SPI_NO(52)
...
#define SPI_GPU_DECOMP			SPI_NO(24)

#define SPI_CLUSTER_PMU_IRQ		SPI_NO(30)

#define SPI_VSFC_RECOVERY		SPI_NO(34)
#define SPI_VSFC_PROFILING		SPI_NO(34)
...
#define SPI_MISC_I2C1_I2C2_SECURE		SPI_NO(56)
#define SPI_MISC_UART1_UART2_SECURE		SPI_NO(56)

#define SPI_MEMC			SPI_NO(29)
#define SPI_NNIP			SPI_NO(30)
#define SPI_NNIP_SECURE			SPI_NO(58)
#define SPI_THERMAL			SPI_NO(41)
#define SPI_THERMAL_SECURE		SPI_NO(57)

#define SPI_NAGRA_M2M			SPI_NO(31)
#define SPI_NAGRA_M2M_SECURE	SPI_NO(60)
#define SPI_NAGRA_ALK			SPI_NO(59)
...
#define IRQ_CPU2CPU		SPI_SB2_SW_INT_SCPU	// ACPU/VCPU/VCPU2 to SCPU
